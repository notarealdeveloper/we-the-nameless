...
\newcommand{\SourceLegendPage}{%
    ...
    \LegendRow{Regular}{%
        The People. We write resular by default. Not bold. Bold is for the bold.\\
    }
...
\newcommand{\PrimevalSourceFontsPage}{%
    ...
    \LegendRow{\LegendFontAlphabet{\hProtoA}}{%
        \eProtoA{
            ...
            resembling the Wadi el-Hol inscriptions, is used for the
    ...
    \LegendRow{\LegendFontAlphabet{\hProtoC}}{%
        \eProtoF{
            A more northern (Sinai peninsula) variant
    ...
    \LegendRow{\LegendFontAlphabet{\hProtoE}}{%
        \eProtoA{
            ...
            for early native Israelite poetry such as the
    ...
    \LegendRow{\LegendFontSampleRows{\PaleoMFont{\color{Pcolor}\mdseries}{אבגדהוזחטיכ}}{\PaleoMFont{\color{Pcolor}\mdseries}{למנסעפצקרשת}}}{%
        \eP{
            The Ketef Hinnom variant of Paleo-Hebrew is
            used for the Priestly Blessing in Numbers 6.
            This is the oldest biblical text yet found.
        }
    }
...
\newcommand{\PrimarySourceFontsPage}{%
    ...
    \LegendRow{\LegendPFontAlphabet}{%
        \eP{
			...
			in a Paleo-Hebrew script during the reign of king Hezekiah.
			The present representation is therefore an anachronism.
