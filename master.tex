...
\DeclareSourceProfile{E}
    ...
    {\PaleoASCIIStandard} {\addfontfeatures{Scale=0.725}\SourceBackground{Ebgcolor}\MushiteStyle\PriestStyle}
...
\DeclareSourceProfile{P}
    ...
    {\HebrewEzraRaw} {\SourceBackground{Pbgcolor}\AaronidStyle\addfontfeatures{Scale=0.649}\mdseries}
