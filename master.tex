...
\newcommand{\SourceLegendPage}{%
    ...
    \LegendRow{Regular}{%
        ...
        W/e, you get it. Now for the others.
    }
    ...
    \footnotetext[\SourceLegendFootnoteE]{{\Yahwist S}he says thanks, and welcome to We.}
    \endgroup
...
\newcommand{\PrimevalSourceFontsPage}{%
    ...
    Archaic songs, poetry, and blessings are rendered in a version
    of the Hebrew alphabet that best matches their time and place
    of composition.
    \par\smallskip
    ...
    \LegendRow{\LegendFontAlphabet{\hProtoA}}{%
        \eProtoA{
            A southern (Egyptian) variant of Proto-Sinaitic resembling the Wadi el-Hol
            inscriptions is used for the oldest source in the bible,
    ...
    \LegendRow{\LegendFontAlphabet{\hProtoC}}{%
        \eProtoF{
            A more northern variant of the Proto-Sinaitic script,
            resembling the Serabit el-Khadim inscriptions in the
            Sinai peninsula, is used for Numbers 21, and the Balaam
            poems in Numbers 23-24.
        }
    }
