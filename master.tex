...
\DeclareChapterLinkRange{Epistles}{1}
...
\DeclareBookChapterSummaryLinkList{Dudetheyreontome}{%
    ...
    \BookPartChapterSummaryLinks{Epistles}%
}
\makeatother
...
\BookPart{Epistles}
\include{10-dudetheyreontome/epistles/1-jephesians}
