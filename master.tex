...
% choices: plain, fancy
\def\IndividualBookTitlePageStyle{plain}
...
\newcommand{\ChapterSummaryLink}[2]{%
    \par\noindent
    \hyperlink{chapter.\CurrentBook.#1}{\ChapterSummaryLinkText{\CurrentBook\ #1: #2}}%
}
\newcommand{\ChapterSummaryLinksForBook}[1]{%
    \begingroup
    \def\CurrentBook{#1}%
    \@ifundefined{ChapterSummaryLinkList@#1}{%
        \ChapterLinksForBook{#1}%
    }{%
        \csname ChapterSummaryLinkList@#1\endcsname
    }%
    \endgroup
}
...
\begin{luacode*}
    ...
    for _, book in ipairs(ordered_books) do
        tex.sprint("\\DeclareChapterSummaryLinkList{" .. tex_escape(book) .. "}{")
        for _, item in ipairs(book_summaries[book]) do
            tex.sprint(
                "    \\ChapterSummaryLink{" .. item.chapter .. "}{" ..
