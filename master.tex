...
\DeclareSourceProfile{E}
    ...
    {\PaleoASCIIStandard} {\addfontfeatures{Scale=0.96}\SourceBackground{Ebgcolor}\MushiteStyle\PriestStyle}
...
\DeclareSourceProfile{P}
    ...
    {\HebrewEzraRaw} {\SourceBackground{Pbgcolor}\AaronidStyle\addfontfeatures{Scale=1.08}\mdseries}
...
\DeclareSourceCommandList{J,E,P,PP,DtrA,DtrB,Dtn,Records,Other,X,Proto,ProtoA,ProtoB,ProtoC,ProtoD,ProtoE,ProtoF,ProtoG,Paleo,PaleoA,PaleoB,PaleoC,PaleoD,PaleoE,PaleoF,PaleoG,PaleoH,PaleoI,PaleoJ,PaleoK,PaleoL,PaleoM,PaleoN,PaleoO,PaleoP,PaleoQ,PaleoR,PaleoS,PaleoT,PaleoU,PaleoV,PaleoW,PaleoX,PaleoY}
...
\newcommand{\SourceLegendPage}{%
    ...
    \SourceLegendRow{{\LawFont Mono}}{%
        {\LawFont
            Laws.\par
            All forms of code, legal and otherwise, are written in mono%
            spaced font, for reasons that need not be explained.\par

            \smallskip
            \noindent
                \begin{tabular}[t]{@{}>{\RaggedRight\arraybackslash}l@{\quad}>{\RaggedRight\arraybackslash}p{0.72\linewidth}@{}}
            {\MushiteStyle
            Mushite Laws:} &
            {\MushiteStyle Covenant Code (Exodus 20:22--23:19)}\\
            &
            {\MushiteStyle Deuteronomistic Law Code (Dtn).}\\[0.7em]

            {\AaronidStyle
            Aaronid Laws:} &
            {\AaronidStyle Dear lord.}\\[0.7em]
            ...
            {\Yahwist J Laws:} &
            {\Yahwist Nonexistent, with the exception of a weird version of
...
\newcommand{\LegendFontSample}[1]{%
    \makebox[\linewidth][r]{\resizebox{0.96\linewidth}{!}{#1}}%
}
...
\newcommand{\PrimevalSourceFontsPage}{%
    ...
    \begin{tabular}{@{}>{\RaggedRight\arraybackslash}p{0.43\linewidth}>{\RaggedRight\arraybackslash}p{0.51\linewidth}@{}}
        ...
        \LegendFontSample{\hProtoA{אבגדהוזחטיכלמנסעפצקרשת}}
        &
        \eProtoA{
        ...
        \LegendFontSample{\hProto{אבגדהוזחטיכלמנסעפצקרשת}}
        &
        \eProto{
        ...
        \LegendFontSample{\hProtoF{אבגדהוזחטיכלמנסעפצקרשת}}
        &
        \eProtoF{
        ...
        \LegendFontSample{\PaleoMFont{\color{Pcolor}\mdseries}{אבגדהוזחטיכלמנסעפצקרשת}}
        &
        \eP{
        ...
        \LegendFontSample{\hRecords{אבגדהוזחטיכלמנסעפצקרשת}}
        &
        \eBookOfRecords{
...
\newcommand{\PrimarySourceFontsPage}{%
    ...
    \begin{tabular}{@{}>{\RaggedRight\arraybackslash}p{0.43\linewidth}>{\RaggedRight\arraybackslash}p{0.51\linewidth}@{}}
        ...
        \LegendFontSample{\hJ{אבגדהוזחטיכלמנסעפצקרשת}}
        &
        \eJ{
        ...
        \LegendFontSample{\hE{אבגדהוזחטיכלמנסעפצקרשת}}
        &
        \eE{
            E is Mushite and Levite, but uses a clean Paleo-Hebrew hand.
            Less chaos, same priestly north/south argument.
        }
        \\

        \LegendFontSample{\hP{אבגדהוזחטיכלמנסעפצקרשת}}
        &
        \eP{
            P defaults to Ezra square script with niqqud: anachronistic,
            but spiritually correct, because P loves the dots. A
            Hezekiah-era Paleo-Hebrew version is available when P needs to
            look like what P probably would have written.
        }
        \\

        \LegendFontSample{\hR{אבגדהוזחטיכלמנסעפצקרשת}}
        &
        \eR{
            R uses Ezra square script with no niqqud,
...
\newcommand{\Chapter}[1]{%
    ...
    \addcontentsline{toc}{section}{\CurrentBook\ #1}%
...
\Book{Esther}
\include{10-esther/01}
\include{10-esther/02}
\include{10-esther/03}
\include{10-esther/04}
\include{10-esther/05}
\include{10-esther/06}
\include{10-esther/07}
\include{10-esther/08}
\include{10-esther/09}
\include{10-esther/10}
...
\include{11-ezra/10}
\BookPart{Nehemiah}
\include{11-ezra/nehemiah-01}
\include{11-ezra/nehemiah-02}
\include{11-ezra/nehemiah-03}
\include{11-ezra/nehemiah-04}
\include{11-ezra/nehemiah-05}
\include{11-ezra/nehemiah-06}
\include{11-ezra/nehemiah-07}
\include{11-ezra/nehemiah-08}
\include{11-ezra/nehemiah-09}
\include{11-ezra/nehemiah-10}
\include{11-ezra/nehemiah-11}
\include{11-ezra/nehemiah-12}
\include{11-ezra/nehemiah-13}
