...
\newcommand{\PrimevalSourceFontsPage}{%
    ...
    \LegendRow{\LegendFontAlphabet{\hProtoA}}{%
        \eProtoA{
            A southern (Egyptian) variant of Proto-Sinaitic resembling the Wali el-Hol
            inscriptions is used for the Song of the Sea (Exodus 15).
        }
    }

    \LegendRow{\LegendFontAlphabet{\hProtoC}}{%
        \eProtoF{
            A northern (Sinai peninsula) variant of Proto-Sinaitic resembling
            the Serabit el-Khadim inscriptions is used for Numbers 21 and the
            Balaam poems in Numbers 23-24.
        }
    }

    \LegendRow{\LegendFontAlphabet{\hProtoE}}{%
        \eProtoA{
            A variant of the Proto-Canaanite script is used
            for early Israelite poetry such as the Song of Deborah
            (Judges 5).
        }
    }
    ...
    \LegendRow{\LegendFontAlphabet{\hProto}}{%
        \eProto{
            A different variant of the Proto-Canaanite script is used
            for early Israelite poetry included in the J portions of
            the Torah, such as the Blessing of Jacob (Genesis 49).
        }
    }
...
\newcommand{\PrimarySourceFontsPage}{%
    ...
    \LegendRow{\LegendPFontAlphabet}{%
        \eP{
			...
			according the words I have said as I said them.\textquotedblright{}
			}
