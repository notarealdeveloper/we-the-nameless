...
\newcommand{\SourceLegendPage}{%
    ...
    \begin{tabular}{@{}>{\RaggedRight\arraybackslash}p{0.23\linewidth}>{\RaggedRight\arraybackslash}p{0.71\linewidth}@{}}
        ...
        \eJ{
            ...
            The author in the bible with the best sense of humor.
        }
        \\
    ...
    \SourceLegendRow{{\LawFont Mono}}{%
        {\LawFont
            Laws.\LegendFootmark{SourceLegendMonoFootnote}\par
            \smallskip
            \noindent
            ...
            commandments, which may well have been a joke, because J is
            f\redacted{ucking}\eR{oundational to a\linebreak[1] understanding of God's
            mysteries and} awesome \eR{power.}}\LegendFootmarkJ{SourceLegendThanksFootnote}%
            \end{tabular}%
        }
    }
