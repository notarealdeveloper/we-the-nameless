...
\newcommand{\SourceLegendPage}{%
    ...
    \begin{tabular}{@{}p{0.23\linewidth}p{0.71\linewidth}@{}}
        ...
        \LegendFootmark{SourceLegendPriestFootnote}%
        (\Priest{\Mushite{E}},
        ...
        {\LawFont
            ...
            \Mushite{Mushite Laws}\par
            - Covenant Code (Exodus 20:22–23:19)\par
            - Deuteronomistic Law Code (Dtn).\par

            \Aaronid{Aaronid Laws}\par
            - Exodus 25-40, where P talks how it's the law
            to make him pretty clothes and bring him gold and doesn't
            stop until damn well into Numbers, somewhere around the part
            that's clearly the origin of the 12 Days of Christmas song.
            They even say ``two turtledoves,'' it's not subtle.\par
            ...
            \LegendFootmark{SourceLegendThanksFootnote}%
        }
        \\

    \end{tabular}

    \footnotetext[\SourceLegendPriestFootnote]{Not according to \Aaronid{these guys},
        though \Mushite{these guys} agree.}
    ...
    \footnotetext[\SourceLegendThanksFootnote]{She says thanks, welcome to We.}
    \endgroup
