...
\newcommand{\PrimevalSourceFontsPage}{%
    ...
    \LegendRow{\LegendFontAlphabet{\hProtoA}}{%
        \eProtoA{
            A southern (Egyptian) variant of the Proto-Sinaitic script,
            resembling the Wali el-Hol inscriptions, is used for the
            oldest source in the bible, the Song of the Sea (Exodus 15).
        }
    }

    \LegendRow{\LegendFontAlphabet{\hProtoC}}{%
        \eProtoF{
            A somewhat more northern (Sinai peninsula) variant
            of the Proto-Sinaitic script resembling the
            Serabit el-Khadim inscriptions, is used for
    ...
    \LegendRow{\LegendFontAlphabet{\hProtoE}}{%
        \eProtoA{
            ...
            for the  earliest Israelite poetry such as the
    ...
    \LegendRow{\LegendFontAlphabet{\hProto}}{%
        \eProto{
            ...
            for the early Israelite poetry included in the
            J portions of the Torah such as the Blessing
            of Jacob (Genesis 49).
        }
    }
