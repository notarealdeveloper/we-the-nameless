...
\colorlet{HLAbgcolor}{Kcolor!22!white}
\colorlet{HLBbgcolor}{Redcolor!22!white}
\colorlet{HLCbgcolor}{Bluecolor!32!white}
...
\ifx\ConfigTheme\ConfigThemeDark
    ...
    \colorlet{Rbgcolor}{Rcolor!22!bg}
    ...
    \colorlet{HLBbgcolor}{Redcolor!22!bg}
    \colorlet{HLCbgcolor}{Bluecolor!32!bg}
    \pagecolor{bg}
...
\newcommand{\LegendRow}[2]{%
    \noindent
    \begin{minipage}[t]{\LegendLeftWidth}\RaggedRight #1\end{minipage}%
    \hfill
    \begin{minipage}[t]{\LegendRightWidth}\RaggedRight #2\end{minipage}%
    \par\vspace{0.7em}%
}
...
\newcommand{\SourceLegendPage}{%
    ...
    \LegendRow{Regular}{%
        The People. We don't write in bold by default. Bold is for the bold.\\
    }
    ...
    \LegendRow{\eJ{Green}}{%
        \eJ{
            J. The first author of the bible.%
            \LegendFootmark{SourceLegendSongsFootnote}
            %
            The first author of prose.%
            \LegendFootmark{SourceLegendEarthFootnote}\\
            The author of the most remembered bible stories.\\
            The author with the best sense of humor.\\
        }
    }
    ...
    \LegendRow{{\Aaronid{Blue}}}{%
        \Aaronid{
            ...
            Associated with king Hezekiah, the Jerusalem priesthood,\\
    ...
    \LegendRow{\eR{Highlights}}{%
        \eR{
            Editors. Called Redactors in bible circles, presumably since E was already taken.\\
            Don't write much, but may occasionally write small amounts of glue prose to make\\
            multiple sources consistent. Some redactors prefer to include both copies of a\\
            story when merging two texts with different versions of the same event\\
        }
        \eRJE{
    ...
    \LegendRow{{\Record Grey}}{%
        {\Record
            Records, begat lists, genealogies, misc documents (Gen 5, Gen 14.)\par
        }
    }
    ...
    \LegendRow{{\LawFont Mono}}{%
        {\LawFont
            Laws.\LegendFootmark{SourceLegendMonoFootnote}\par\smallskip
            ...
            {\Yahwist J Laws: Nonexistent. Except for a weird version of\\
            the 10 commandments, which may well have been a joke, because\\
    ...
    \footnotetext[\SourceLegendMonoFootnote]{All forms of code, legal and otherwise,
    	are written in monospaced font, for reasons that need not be explained.}
...
\newcommand{\PrimevalSourceFontsPage}{%
    ...
    \begingroup
    \footnotesize
    \LegendColumns{0.50\linewidth}{0.44\linewidth}
    ...
    \LegendRow{\LegendFontSample{\hProtoA{אבגדהוזחטיכלמנסעפצקרשת}}}{%
        \eProtoA{
            The Proto-Sinaitic script is used for the oldest strata of biblical songs.\\
            The southern variant of Proto-Sinaitic is used for Song of the Sea (Exodus 15).
        }
    }

    \LegendRow{\LegendFontSample{\hProtoB{אבגדהוזחטיכלמנסעפצקרשת}}}{%
        \eProtoA{
            The northern variant of Proto-Sinaitic is used for the Song of Deborah (Judges 5).
        }
    }

    \LegendRow{\LegendFontSample{\hProto{אבגדהוזחטיכלמנסעפצקרשת}}}{%
        \eProto{
            A northern variant of the Proto-Canaanite script is used\\
            for early Israelite poetry such as the Blessing of Jacob\\
            (Genesis 49).
        }
    }

    \LegendRow{\LegendFontSample{\hProtoF{אבגדהוזחטיכלמנסעפצקרשת}}}{%
        \eProtoF{
            A southern variant of the Proto-Canaanite script is used\\
			for Numbers 21 and the old Balaam poems in Numbers 23-24.
        }
    }

    \LegendRow{\LegendFontSample{\PaleoMFont{\color{Pcolor}\mdseries}{אבגדהוזחטיכלמנסעפצקרשת}}}{%
        \eP{
            The Ketef Hinnom variant of Paleo-Hebrew is used for the\\
            Priestly Blessing in Numbers 6. This is the oldest biblical\\
            text yet found.
        }
    }

    \LegendRow{\LegendFontSample{\hRecords{אבגדהוזחטיכלמנסעפצקרשת}}}{%
        \eBookOfRecords{
            The block variant of Paleo Hebrew bureaucracy is used for\\
            excerpts from the Book of Records containing begat lists,\\
            genealogies, and ages at birth of first child and at death\\
            (Genesis 5, Genesis 10.)
        }
    }
    \endgroup
...
\newcommand{\PrimarySourceFontsPage}{%
    ...
    \LegendRow{\LegendFontSample{\hJ{אבגדהוזחטיכלמנסעפצקרשת}}}{%
        \eJ{
            J is written in the Paleo-Hebrew script of around 922 B.C.
        }
    }

    \LegendRow{\LegendFontSample{\hE{אבגדהוזחטיכלמנסעפצקרשת}}}{%
        \eE{
            E is uses a norther variant of the Paleo-Hebrew script\\
            from soon after the time of J.
        }
    }

    \LegendRow{\LegendFontSample{\hP{אֲבֱגֶּדֲהֹוּזֻחִטֳיִּכֻלֵּמֱנָסֶעֲפֹצֻקָרֶשְּׁתֽ}}}{%
        \eP{
			P is represented in the Hebrew square script with niqqud.\\
			In all likelihood, the Priestly source was originally written\\
			Paleo-Hebrew script of the age of Hezekiah. The present\\
			representation is therefore an anachronism.

			Nevertheless, much to our frustration, P insisted that his\\
			source material be represented in this manner, and he spoke\\
			to us, saying:

			\eP{
			The niqqud provide the \textsc{Author} with a method,
			...
			as having intentionally employed paranomasia, that is, a pun,
			a double meaning, a wordplay, or some other such comparable
			device of ambiguity. The use of paranomasia, that is, punning,
			...
			him and his sons and his sons wives with him. I am YHWH.''
			}

			We have complied, reluctantly, and trust the reader will pardon the
			anachronism.
        }
    }

    \LegendRow{\LegendFontSample{\hR{אבגדהוזחטיכלמנסעפצקרשת}}}{%
        \eR{
...
\newcommand{\AlphabetHistoryPage}{%
    ...
    \AlphabetHistoryASCII{\HebrewDavidFont}{2.18}{\healphabet}\\
    \AlphabetHistoryASCII{\HebrewEzraFont}{2.20}{\healphabet}\\
    \end{flushright}
    %\cleardoublepage
}
