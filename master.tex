...
\ifx\ConfigTheme\ConfigThemeDark
    ...
    \definecolor{Rbgcolor}{HTML}{3a4960}
...
\newcommand{\SourceLegendPage}{%
    ...
    \begin{tabular}{@{}p{0.23\linewidth}p{0.71\linewidth}@{}}
        ...
        (\Priest{\Mushite{E}},
        \SourceDecorate[dtr1,redactor,priest]{Dtr1},
        \SourceDecorate[dtr2,redactor,priest]{Dtr2},
        \Jeremiah[priest]{Jeremiah},
        \SourceDecorate[aaronid,redactor,priest]{R}.)
        \\
        ...
        &
        {\LawFont{\Mushite{Covenant Code in Exodus}; \Mushite[mono]{Deuteronomistic Law Code} (\Mushite[mono]{Dtn}).}}
        \\

        {\LawFont\cG{J Laws}}
        &
        {\LawFont\cG{Rare. Possibly a joke.\LegendFootmark{SourceLegendFunnyFootnote}}}
        \\
    ...
    \footnotetext[\SourceLegendFunnyFootnote]{She's the funny one.}
