...
\newcommand{\LDPublicationNoticePage}{%
    ...
    \aC{\ttfamily
        volume any earlier sources either in paraphrase or verbatim.\\
        If your work has been incorporated into the resulting volume\\
        and you would like to be removed from the bible, contact us.\\
        It is, at least, a bible, and the rules of that genre apply.
    }\par
    }
...
\newcommand{\AlphabetHistoryPage}{%
    ...
    \AlphabetHistoryLeftToRight{\PaleoHebrewTelZayitFont}{1.81}{ABGDHWZXTYKLMNSOPCQRst}\\
