...
\colorlet{JEcolor}{Jcolor!50!Ecolor}
...
\DeclareSourceProfile{JE}
	{\EnglishFont}				{\color{JEcolor}\mdseries}
	{\PaleoHebrewPhoenician}	{\color{JEcolor}\mdseries}
...
\DeclareSourceProfile{Red}
	{\EnglishFont}				{\SourceBackground{RedSourcebgcolor}\color{RedSourcecolor}\Redactor\mdseries}
	{\HebrewEzraRaw}			{\SourceBackground{RedSourcebgcolor}\color{RedSourcecolor}\Redactor\addfontfeatures{Scale=1.40}\mdseries}
	% Don't change this font scale!
...
\NewDocumentCommand{\ApplyEnglishSourceProfile}{ m +m }{%
  {%
    \let\SourceProfileTextWrapper\SourceProfilePlainText
    #1%
    \let\SourceProfileOriginalFootnote\footnote%
    \RenewDocumentCommand{\footnote}{ o +m }{%
      \IfValueTF{##1}%
        {\SourceProfileOriginalFootnote[##1]{{\let\SourceProfileTextWrapper\SourceProfilePlainText #1\SourceProfileTextWrapper{##2}}}}%
        {\SourceProfileOriginalFootnote{{\let\SourceProfileTextWrapper\SourceProfilePlainText #1\SourceProfileTextWrapper{##2}}}}%
    }%
...
\DeclareBookChapterSummaryLinkList{Genesis}{%
    ...
    \ChapterSummaryLink{Genesis}{29}{Genesis}{Accidental sister-wives; White lies}%
    \ChapterSummaryLink{Genesis}{30}{Genesis}{Sibling rivalry breeding competition}%
