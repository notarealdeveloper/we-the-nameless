...
\DeclareBookChapterSummaryLinkList{Genesis}{%
    ...
    \ChapterSummaryLink{Genesis}{3}{Genesis}{Serpent; exile}%
    ...
    \ChapterSummaryLink{Genesis}{12}{Genesis}{Abram called}%
    \ChapterSummaryLink{Genesis}{13}{Genesis}{Abram, Lot split}%
    \ChapterSummaryLink{Genesis}{14}{Genesis}{Lot rescued}%
    \ChapterSummaryLink{Genesis}{15}{Genesis}{Covenant cut}%
    \ChapterSummaryLink{Genesis}{16}{Genesis}{Hagar flees}%
    \ChapterSummaryLink{Genesis}{17}{Genesis}{Cut scene; YHWH's comeback}%
    \ChapterSummaryLink{Genesis}{18}{Genesis}{Visitors; Sodom}%
    \ChapterSummaryLink{Genesis}{19}{Genesis}{Sodom destroyed}%
    \ChapterSummaryLink{Genesis}{20}{Genesis}{Abimelech fooled}%
    \ChapterSummaryLink{Genesis}{21}{Genesis}{Isaac born}%
    \ChapterSummaryLink{Genesis}{22}{Genesis}{Isaac b\{o,\}u\{,r\}n\{,e\}d}%
    \ChapterSummaryLink{Genesis}{23}{Genesis}{Sarah buried}%
    \ChapterSummaryLink{Genesis}{24}{Genesis}{Rebekah found}%
    \ChapterSummaryLink{Genesis}{25}{Genesis}{Esau, Jacob born}%
    \ChapterSummaryLink{Genesis}{26}{Genesis}{Isaac prospers}%
    \ChapterSummaryLink{Genesis}{27}{Genesis}{Blessing stolen}%
    \ChapterSummaryLink{Genesis}{28}{Genesis}{Ladder dream}%
    \ChapterSummaryLink{Genesis}{29}{Genesis}{Leah, Rachel}%
    \ChapterSummaryLink{Genesis}{30}{Genesis}{Jacob prospers}%
    \ChapterSummaryLink{Genesis}{31}{Genesis}{Jacob leaves}%
    \ChapterSummaryLink{Genesis}{32}{Genesis}{Jacob wrestles}%
    \ChapterSummaryLink{Genesis}{33}{Genesis}{Esau returns}%
    \ChapterSummaryLink{Genesis}{34}{Genesis}{Dinah and Shechem}%
    \ChapterSummaryLink{Genesis}{35}{Genesis}{Bethel; Rachel dies}%
