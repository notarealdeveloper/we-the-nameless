...
\def\ConfigCommentaryAll{all}
\def\ConfigCommentaryNone{none}
\newif\ifConfigCommentaryOn
\newif\ifConfigVerseLayoutVertical
\newif\ifConfigOutputModeMobile
\ifx\ConfigCommentary\ConfigCommentaryAll
...
\newcommand{\DeclareBookPartList}[2]{%
    \expandafter\def\csname BookPartList@#1\endcsname{#2}%
}
\newcommand{\RecordVerseLink}[4]{%
    \@ifundefined{VerseLinkList@#1@#2}{%
        \expandafter\gdef\csname VerseLinkList@#1@#2\endcsname{%
            \VerseLinkTo{#1}{#2}{#3}{#4}%
        }%
    }{%
        \expandafter\g@addto@macro\csname VerseLinkList@#1@#2\endcsname{%
            \VerseLinkSeparator
            \VerseLinkTo{#1}{#2}{#3}{#4}%
        }%
    }%
}
\newcommand{\WriteVerseLink}[1]{%
    \protected@write\@auxout{}{%
        \string\RecordVerseLink{\CurrentBook}{\CurrentChapter}{\the\CurrentVerseIndex}{\unexpanded{#1}}%
    }%
}
...
\newcommand{\NavigationLinkText}[1]{%
    \ChapterLinkText{#1}%
}
\newcommand{\ChapterLink}[1]{%
    \hyperlink{chapter.\CurrentBook.#1}{\ChapterLinkText{#1}}%
}
\newcommand{\VerseLinkTo}[4]{%
    \hyperlink{verse.#1.#2.#3}{\NavigationLinkText{#4}}%
}
\newcommand{\ChapterLinkSeparator}{\quad}
\newcommand{\VerseLinkSeparator}{\quad}
...
\newcommand{\VerseLinkArray}{%
    \par\nobreak\smallskip
    \begingroup
    \centering
    \footnotesize
    \@ifundefined{VerseLinkList@\CurrentBook @\CurrentChapter}{}{%
        \csname VerseLinkList@\CurrentBook @\CurrentChapter\endcsname
    }%
    \par\nobreak\smallskip
    \endgroup
}
...
\newcommand{\BookChapterLinkArray}[1]{%
    \@ifundefined{BookPartList@#1}{%
        ...
        \csname BookPartList@#1\endcsname
    }%
}
...
\newcommand{\Chapter}[1]{%
    ...
    \VerseLinkArray
    \markboth{\ChapterHeaderText{#1}}{\ChapterHeaderText{#1}}%
}
...
\newcommand{\Verse}[4]{%
    \par
    \advance\CurrentVerseIndex by 1
    \hypertarget{verse.\CurrentBook.\CurrentChapter.\the\CurrentVerseIndex}{}%
    \WriteVerseLink{#1}%
    \vspace{0.8em}%
    \Needspace{6\baselineskip}
    \VerseRule
