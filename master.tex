...
\newcommand{\SourceLegendPage}{%
    ...
    \LegendRow{Regular}{%
        We the People. We write regular. When we write, it looks regular.\\
        We're not always bold. Bold is for the bold.\\
        We're not always italic. Italic is for the Italians.\\
        We're not always highlighted. Highlighted is for the high \& lighted.\\
        We're not always mono. Mono is for the---\\
