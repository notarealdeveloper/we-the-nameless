...
\definecolor{Ecolor}{RGB}{150,112,0}
...
\colorlet{HLAbgcolor}{Kcolor!28!white}
\colorlet{HLBbgcolor}{Redcolor!28!white}
\colorlet{HLCbgcolor}{Bluecolor!28!white}
\colorlet{HLASubtlebgcolor}{Kcolor!24!white}
\colorlet{HLBSubtlebgcolor}{Redcolor!24!white}
\colorlet{HLCSubtlebgcolor}{Bluecolor!24!white}
...
\ifx\ConfigTheme\ConfigThemeDark
    ...
    \colorlet{HLAbgcolor}{Kcolor!28!bg}
    \colorlet{HLBbgcolor}{Redcolor!28!bg}
    \colorlet{HLCbgcolor}{Bluecolor!28!bg}
    \colorlet{HLASubtlebgcolor}{Kcolor!24!bg}
    \colorlet{HLBSubtlebgcolor}{Redcolor!24!bg}
    \colorlet{HLCSubtlebgcolor}{Bluecolor!24!bg}
...
\newcommand{\hlASubtle}[1]{{\@highLight[HLASubtlebgcolor]#1}}
\newcommand{\hlBSubtle}[1]{{\@highLight[HLBSubtlebgcolor]#1}}
\newcommand{\hlCSubtle}[1]{{\@highLight[HLCSubtlebgcolor]#1}}
\makeatother
