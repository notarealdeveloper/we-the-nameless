    ...
    for pos, code in utf8.codes(s) do
      ...
      elseif not is_hebrew_mark(code) then
        ...
        if char == "[" or char == "]" then
          -- The repaired face contains full-size brackets. Mirror them before
          -- the RTL run so the visible opening and closing forms stay correct.
          table.insert(out, mirrored_bracket[char])
