...
\DeclareSourceProfile{E}
    ...
    {\PaleoASCIIStandard} {\SourceBackground{Ebgcolor}\Mushite}
...
\DeclareSourceProfile{PP}
    {\EnglishFont}       {\SourceBackground{Pbgcolor}\Aaronid}
    {\PaleoASCIIStandard}{\SourceBackground{Pbgcolor}\Aaronid}

\DeclareSourceProfile{R}
    {\EnglishFont}   {\SourceBackground{Rbgcolor}\Aaronid\Redactor\mdseries}
    {\HebrewEzraRaw} {\SourceBackground{Rbgcolor}\Aaronid\Redactor\mdseries}
...
\newcommand{\SourceLegendPage}{%
    ...
    \begin{tabular}{@{}p{0.23\linewidth}p{0.71\linewidth}@{}}
        ...
        &
        {\Poetry
            Songs and early poetry,
            from the {\Levite Levites} in the South
            {\Mushite (}{\Aaronid Exodus 15}{\Mushite , Numbers 21, 23--24, Deuteronomy 33}{\Mushite )},
            \newline
