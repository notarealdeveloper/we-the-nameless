...
\def\cum{c\eR{hildren}}
\def\pussya{p\eR{aternit}y}
\def\pussyb{p\eR{atriarch}y}
\def\pussy{\pussya}
\def\dick{d\eR{ownstairs, ``}ick\eR{,'' I say when I look upon it, for skin is upon it, and it is a distasteful thing, Amen} eh man?}
\def\penisa{p\eR{at}e\eR{r}ni\eR{ty}s}
