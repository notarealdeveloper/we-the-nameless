...
\newcommand{\BookPartChapterLinksForBook}[1]{%
    \par\nobreak\medskip
    \begingroup
    \centering
    \large
    \TableOfContentsLink{#1}\par\nobreak\smallskip
    \def\CurrentBook{#1}%
    \ChapterLinkArray
    \endgroup
}
\newcommand{\BookChapterLinkArray}[1]{%
    \@ifundefined{BookPartLinkList@#1}{%
        \ChapterLinksForBook{#1}%
    }{%
        \csname BookPartLinkList@#1\endcsname
    }%
}
\newcommand{\DeclareBookPart}[2]{%
    \@ifundefined{BookPartLinkList@#1}{%
        \expandafter\gdef\csname BookPartLinkList@#1\endcsname{}%
    }{}%
    \expandafter\g@addto@macro\csname BookPartLinkList@#1\endcsname{%
        \BookPartChapterLinksForBook{#2}%
    }%
}
\newcommand{\RecordBookPart}[1]{%
    \protected@write\@auxout{}{%
        \string\DeclareBookPart{\CurrentTitleBook}{#1}%
    }%
}
...
\newcommand{\VerseLink}[4]{%
    \hyperlink{verse.#1.#2.#3}{\VerseLinkText{#4}}%
}
\newcommand{\VerseLinkSeparator}{\quad}
\newcommand{\DeclareVerseLink}[4]{%
    ...
    \expandafter\g@addto@macro\csname VerseLinkList@#1@#2\endcsname{%
        \VerseLink{#1}{#2}{#3}{#4}\VerseLinkSeparator
    }%
}
...
\newcommand{\RecordVerseLink}[1]{%
    \protected@write\@auxout{}{%
        \string\DeclareVerseLink{\CurrentBook}{\CurrentChapter}{\the\VerseLinkNumber}{\unexpanded{#1}}%
    }%
}
\makeatother
...
\newcommand{\Verse}[4]{%
    \par
    \Needspace{6\baselineskip}
    \advance\VerseLinkNumber by 1
    \hypertarget{verse.\CurrentBook.\CurrentChapter.\the\VerseLinkNumber}{}%
    \RecordVerseLink{#1}%
    \VerseHeader{#1}%
    \begingroup
    \hbadness=10000
