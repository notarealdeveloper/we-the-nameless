...
\ifx\ConfigTheme\ConfigThemeDark
    ...
    \colorlet{Rbgcolor}{Rcolor!17!bg}
...
\newcommand{\PrimevalSourceFontsPage}{%
    ...
    \LegendRow{\LegendFontAlphabet{\hRecords}}{%
        \eBookOfRecords{
            ...
            genealogies, ages at birth of first child, at death, etc.\\
...
\newcommand{\PrimarySourceFontsPage}{%
    ...
    \LegendRow{\LegendPFontAlphabet}{%
        \eP{
			...
			according the words I have said as I said them.
			}

			We have complied, reluctantly, and we trust the reader will pardon the
			anachronism.
        }
    }
    ...
    \LegendRow{\LegendFontAlphabet{\hR}}{%
        \eR{
            ...
            since he is both: 1. writing after the Babylonian exile, and 2. Ezra.
        }
    }
    \endgroup
