...
\newfontfamily\LawFont[Scale=0.90]{DejaVu Sans Mono}
...
\newcommand{\SourceLegendPage}{%
    ...
    \begin{tabular}{@{}p{0.23\linewidth}p{0.71\linewidth}@{}}
        ...
        {\Priest{Bold}}
        &
        {\Priest{The Priests. Or the Levites. Same thing.}}%
        ...
        {\Poetry
            ...
            (\cG{\Levite{Exodus 15}}, \cG{Judges 5}, \cG{Genesis 49}, \Mushite{Numbers 21, 23-24, Deut 33}.)
        }
        \\
