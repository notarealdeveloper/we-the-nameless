...
\DeclareBookChapterSummaryLinkList{NHS}{%
    \ChapterSummaryLink{NHS}{1}{NHS}{The Nth Stair}%
}
...
\DeclareBookChapterSummaryLinkList{Dudetheyreontome}{%
    ...
    \BookPartChapterSummaryLinks{NHS}%
    \EpistlesContents%
}
\makeatother
