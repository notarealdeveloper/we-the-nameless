...
\definecolor{ApocryphonYHWHDialogueColor}{RGB}{90,0,0}
...
\ifx\ConfigTheme\ConfigThemeDark
    ...
    \definecolor{ApocryphonYHWHDialogueColor}{RGB}{150,22,22}
    \colorlet{Dtncolor}{Dtr1color}
...
\newcommand{\ApocryphonYHWHDialogue}[1]{{\color{ApocryphonYHWHDialogueColor}#1}}
