...
\newcommand{\DeuterAPlainStyle}{\MushiteStyle\color{Dtr1color}}
\newcommand{\DeuterBPlainStyle}{\MushiteStyle\color{Dtr2color}}
...
\DeclareRobustCommand{\SourceLegendHeader}{%
    ...
    \eJ{J}\quad
    \eE{E}\quad
    {\EnglishFont\DeuterAPlainStyle\mdseries D}\quad
    \eP{P}\quad
    \eR{R}\quad
    }%
}
