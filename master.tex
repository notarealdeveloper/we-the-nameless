...
\newcommand{\hKetefHinnomLegend}[1]{%
    \PaleoMFont{\Record\mdseries}{#1}%
}
...
\newcommand{\PrimevalSourceFontsPage}{%
    ...
    \LegendRow{\LegendFontAlphabet{\hKetefHinnomLegend}}{%
        \eProto{
...
\newcommand{\PrimarySourceFontsPage}{%
    ...
    \LegendRow{\LegendPFontAlphabet}{%
        \eP{
			...
			This representation is undeniably an anachronism,
			seeing as the linguistic evidence suggests that the
