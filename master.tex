...
\newcommand{\SourceLegendPage}{%
    ...
    \LegendRow{{\LawFont Mono}}{%
        {\LawFont
            ...
            \smallskip
            {\MushiteStyle Mushite Laws: Covenant Code (Exodus 20:22--23:19);
            Deuteronomistic Law Code (Dtn).}\par\smallskip

            {\AaronidStyle Aaronid Laws: Dear lord.}\par\smallskip
            ...
            {\Yahwist J Laws: Nonexistent. Except for a weird version of the 10
