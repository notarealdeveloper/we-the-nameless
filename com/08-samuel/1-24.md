...
1. Let us take it as given that I'm a very unthreatening animal metaphor.
2. Now, in the category Beh of behaviors, the silliness of a behavior is preserved under maps between a metaphor's source object or domain, and its target object or codomain.
3. Therefore, the diagram commutes, and the theorem follows.
...
1. David is right.
2. Saul is wrong.
3. David has treated Saul generously.
4. Saul has treated David badly.
