...
%%% mistress.tex
%%%
%%% A simpler LuaLaTeX architecture for the same book design.
...
% ------------------------------------------------------------
\directlua{
  nameless = nameless or {}
  nameless.config = {
    theme = "dark",
    verse_layout = "horizontal",
    output_mode = "mobile",
    commentary = true,
    individual_book_title_page_style = "fancy",
    geometry = {
      book = { paperwidth = "7in", paperheight = "10in", inner = "0.8in", outer = "0.45in", top = "0.55in", bottom = "0.75in" },
      mobile = { paperwidth = "7in", paperheight = "14.68in", left = "0.625in", right = "0.625in", top = "0.55in", bottom = "0.75in" },
    },
    verse = { gap = "0.75em", rule_width = "0.2pt" },
  }
}

% Compatibility names expected by the existing TeX-facing API.
...
% ------------------------------------------------------------
\begin{luacode*}
nameless.source_categories = {
  primeval = { label = "Primeval", description = "archaic songs, blessings, records, and early inscriptions" },
  yahwist = { label = "Yahwist", description = "J and related green native prose" },
  mushite = { label = "Mushite", description = "E, Deuteronomists, Deuteronomic law, Jeremiah" },
  aaronid = { label = "Aaronid", description = "P, R, Ezekiel, and Jerusalem priestly material" },
  redactor = { label = "Redactor", description = "editorial bridge and harmonizing prose" },
  records = { label = "Records", description = "genealogies and documentary lists" },
  other = { label = "Other", description = "material outside the main source profiles" },
}
nameless.source_profiles = {
  J = { category = "yahwist", english = "EnglishFont", hebrew = "PaleoHebrewPhoenician", color = "Jcolor", background = "Jbgcolor" },
  E = { category = "mushite", english = "EnglishFont", hebrew = "PaleoASCIIStandard", color = "Ecolor", background = "Ebgcolor" },
  P = { category = "aaronid", english = "EnglishFont", hebrew = "HebrewEzraRaw", color = "Pcolor", background = "Pbgcolor" },
  R = { category = "redactor", english = "EnglishFont", hebrew = "HebrewEzraRaw", color = "Rcolor", background = "Rbgcolor" },
  DtrA = { category = "mushite", english = "EnglishFont", hebrew = "HebrewDavid", color = "Dtr1color", background = "Dtr1bgcolor" },
  DtrB = { category = "mushite", english = "EnglishFont", hebrew = "HebrewDavid", color = "Dtr2color", background = "Dtr2bgcolor" },
  Dtn = { category = "mushite", english = "LawFont", hebrew = "HebrewDavid", color = "Dtncolor", background = "Dtnbgcolor" },
  Records = { category = "records", english = "EnglishFont", hebrew = "PaleoHebrewMono", color = "RecordsColor", background = "Recordsbgcolor" },
  Other = { category = "other", english = "EnglishFont", hebrew = "PaleoASCIIMoabite", color = "OtherColor", background = "Otherbgcolor" },
}
\end{luacode*}
...
% Alphabet-history layout and glyph-sequence macros.
...
\DeclareBookChapterSummaryLinkList{Genesis}{%
    ...
    \ChapterSummaryLink{Genesis}{29}{Genesis}{Accidental sister-wives}%
    \ChapterSummaryLink{Genesis}{30}{Genesis}{Sibling rivalry}%
    \ChapterSummaryLink{Genesis}{31}{Genesis}{Outwitting Laban}%
    \ChapterSummaryLink{Genesis}{32}{Genesis}{Night wrestling}%
    \ChapterSummaryLink{Genesis}{33}{Genesis}{Esau returns}%
...
\DeclareBookChapterSummaryLinkList{Leviticus}{%
    \ChapterSummaryLink{Leviticus}{1}{Leviticus}{Burnt offerings}%
    \ChapterSummaryLink{Leviticus}{2}{Leviticus}{Grain offerings}%
    \ChapterSummaryLink{Leviticus}{3}{Leviticus}{Well-being offerings}%
    \ChapterSummaryLink{Leviticus}{4}{Leviticus}{Sin offerings}%
    \ChapterSummaryLink{Leviticus}{5}{Leviticus}{Guilt; confession}%
    \ChapterSummaryLink{Leviticus}{6}{Leviticus}{Offering rules}%
    \ChapterSummaryLink{Leviticus}{7}{Leviticus}{More offering rules}%
...
\newcommand{\Apocrypha}[1]{%
    ...
    \centering
    \vspace*{1.6em}%
    {\DeadSeaScrollsIsaiahFont\fontsize{24}{28}\selectfont\color{RuleColor}\paleolower\par}%
    \vspace{0.8em}%
...
\newcommand{\Apocryphon}[1]{%
    ...
    %\end{minipage}\par
    \vspace{0.35em}%
    {\DeadSeaScrollsIsaiahFont\large\color{RuleColor}\paleoijklower\par}%
    \vspace{0.55em}%
    \makebox[\linewidth]{\color{RuleColor}\rule{0.38\linewidth}{0.4pt}}%
    \par
    \vspace{1.0em}%
...
% ------------------------------------------------------------
% The block renderers above keep the public chapter-file API stable:
% Hebrew, English, and commentary remain the second, third, and fourth
% arguments of \Verse, while source-specific wrappers consult the source
% profiles defined earlier.
...
% ------------------------------------------------------------
% Chapter summaries are declared above because the title-page machinery needs
% TeX token lists for styled entries such as \IsaacBoundBurnedSummary. Their
% declarations are clustered together in the book-level section.
...
\begin{luacode*}
nameless.corpus = {
  { book = "Genesis", includes = {
    "01-genesis/01", "01-genesis/02", "01-genesis/03", "01-genesis/04", "01-genesis/05",
    "01-genesis/06", "01-genesis/07", "01-genesis/08", "01-genesis/09", "01-genesis/10",
    "01-genesis/11", "01-genesis/12", "01-genesis/13", "01-genesis/14", "01-genesis/15",
    "01-genesis/16", "01-genesis/17", "01-genesis/18", "01-genesis/19", "01-genesis/20",
    "01-genesis/21", "01-genesis/22", "01-genesis/23", "01-genesis/24", "01-genesis/25",
    "01-genesis/26", "01-genesis/27", "01-genesis/28", "01-genesis/29", "01-genesis/30",
    "01-genesis/31", "01-genesis/32", "01-genesis/33", "01-genesis/34", "01-genesis/35",
    "01-genesis/36", "01-genesis/37", "01-genesis/38", "01-genesis/39", "01-genesis/40",
    "01-genesis/41", "01-genesis/42", "01-genesis/43", "01-genesis/44", "01-genesis/45",
    "01-genesis/46", "01-genesis/47", "01-genesis/48", "01-genesis/49", "01-genesis/50",
    "01-genesis/apocrypha",
  } },
  { book = "Exodus", range = { prefix = "02-exodus/", first = 1, last = 40 } },
  { book = "Leviticus", range = { prefix = "03-leviticus/", first = 1, last = 27 } },
  { book = "Numbers", range = { prefix = "04-numbers/", first = 1, last = 36 } },
  { book = "Deuteronomy", range = { prefix = "05-deuteronomy/", first = 1, last = 34 } },
  { book = "Joshua", range = { prefix = "06-joshua/", first = 1, last = 24 } },
  { book = "Judges", range = { prefix = "07-judges/", first = 1, last = 21 } },
  { book = "Samuel", parts = {
    { name = "I Samuel", prefix = "08-samuel/1-", first = 1, last = 31 },
    { name = "II Samuel", prefix = "08-samuel/2-", first = 1, last = 24 },
  } },
  { book = "Kings", parts = {
    { name = "I Kings", prefix = "09-kings/1-", first = 1, last = 22 },
    { name = "II Kings", prefix = "09-kings/2-", first = 1, last = 25 },
  } },
  { book = "Dudetheyreontome", parts = {
    { name = "On the Lamb", includes = { "10-dudetheyreontome/title" } },
    { name = "Ezra", prefix = "10-dudetheyreontome/ezra/", first = 1, last = 10 },
    { name = "Nehemiah", prefix = "10-dudetheyreontome/nehemiah/", first = 1, last = 13 },
    { name = "Esther", prefix = "10-dudetheyreontome/esther/", first = 1, last = 10 },
  } },
}

local function include_path(prefix, n)
  return string.format("%s%02d", prefix, n)
end

local function emit_include(path)
  tex.sprint("\\include{" .. path .. "}")
end

local function emit_range(range)
  for n = range.first, range.last do
    emit_include(include_path(range.prefix, n))
  end
end

local function emit_includes(includes)
  for _, path in ipairs(includes or {}) do
    emit_include(path)
  end
end

function nameless.render_corpus()
  tex.sprint("\\mainmatter")
  tex.sprint("\\hypersetup{pageanchor=true}")
  tex.sprint("\\pagestyle{fancy}")
  for _, book in ipairs(nameless.corpus) do
    tex.sprint("\\Book{" .. book.book .. "}")
    if book.includes then emit_includes(book.includes) end
    if book.range then emit_range(book.range) end
    for _, part in ipairs(book.parts or {}) do
      tex.sprint("\\BookPart{" .. part.name .. "}")
      if part.includes then emit_includes(part.includes) end
      if part.prefix then emit_range(part) end
    end
  end
end
\end{luacode*}

\directlua{nameless.render_corpus()}
