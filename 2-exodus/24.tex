...
\Verse{1}
{
	\hJ{וְאֶל מֹשֶׁה אָמַר עֲלֵה אֶל יְהֹוָה אַתָּה וְאַהֲרֹן נָדָב וַאֲבִיהוּא וְשִׁבְעִים מִזִּקְנֵי יִשְׂרָאֵל וְהִשְׁתַּחֲוִיתֶם מֵרָחֹק׃}
}
{
	\eJ{
		24 And He said to Moses, “Come up to YHWH: you and Aaron,
...
\Verse{2}
{
	\hJ{וְנִגַּשׁ מֹשֶׁה לְבַדּוֹ אֶל יְהֹוָה וְהֵם לֹא יִגָּשׁוּ וְהָעָם לֹא יַעֲלוּ עִמּוֹ׃}
}
{
	\eJ{
...
{
	\eE{
		And they saw the {\God} of Israel. And below His feet it was
		like a structure of sapphire brick and like the essence of
		the skies for clarity. 24:10–11. And they saw {\God}. … And
		they envisioned {\God}. Some have taken this to mean that
		they literally, physically see {\God}. But, as Ibn Ezra
		properly observed, the verb for “they saw” (Hebrew r’h) is
		also used to refer to seeing in a vision, as when Isaiah
		says, “I saw the Lord sitting on a throne” (Isa 6:1). This
		meaning of “they saw” here is confirmed by the parallel
		use in v. 11 of the word “envisioned” (Hebrew zh), which
		regularly means to have a vision (as, for example in Isa
		1:1). Also, this is consistent with the idea that no one
		ever sees the actual form of {\God} except Moses on a single
		occasion. This idea is understood throughout the Tanak,
		without exception. (On the distinction between vision and
...
\Verse{15}
{
	\hE{וַיַּעַל מֹשֶׁה אֶל הָהָר וַיְכַס הֶעָנָן אֶת הָהָר׃}
}
{
	\eE{
		And Moses went up to the mountain. And the cloud covered
		the mountain.
	}
}
{
...
\Verse{16}
{
	\hOther{וַיִּשְׁכֹּן כְּבוֹד יְהֹוָה עַל הַר סִינַי וַיְכַסֵּהוּ הֶעָנָן שֵׁשֶׁת יָמִים וַיִּקְרָא אֶל מֹשֶׁה בַּיּוֹם הַשְּׁבִיעִי מִתּוֹךְ הֶעָנָן׃}
}
{
	\eOther{
...
\Verse{17}
{
	\hOther{וּמַרְאֵה כְּבוֹד יְהֹוָה כְּאֵשׁ אֹכֶלֶת בְּרֹאשׁ הָהָר לְעֵינֵי בְּנֵי יִשְׂרָאֵל׃}
}
{
	\eOther{
...
\Verse{18}
{
	\hOther{וַיָּבֹא מֹשֶׁה בְּתוֹךְ הֶעָנָן וַיַּעַל אֶל הָהָר וַיְהִי מֹשֶׁה בָּהָר אַרְבָּעִים יוֹם וְאַרְבָּעִים לָיְלָה׃}
}
{
	\eOther{
		And Moses came inside the cloud and went up into the
