...
R: (Non-maliciously, the tone seems more like how a policeman acts if a third party sees him not enforcing some law that they basically never enforce so he needs to come over and give you a talking to, because of the third party, because that's his job you know what I mean.) J, please come prepared next time.
...
Goto: [[main.c|Minutes of meeting on Genesis 1, and how the final version you know (and maybe love) came to be, as a result of the distinct personalities of these three, and look up the Documentary Hypothesis if none of that made sense or more simply in summary: Welcome to We.]][^2]
...
[^2]: And yes of course I'm aware that that "three" should be "four" but give me some slack, it sounds better like that and who knows, maybe We started counting at zero, or maybe that three should be two b/c it was mostly a disagreement that P had with me, or like maybe just one because hell in the end I mostly just gave Gen 1 to him so he'd have a win early on b/c I wanted our relationship (or whatever that was) to get off on the right foot which it didn't. In summary, be humble, lots of stuff can be right when you write there's all sorts of stuff you aren't allowed to write right ok so when you're reading a thing you didn't write, then maybe just trust that the people who did had to bust up their ~~ass(es)~~ seat on a hard ~~ass~~ wood seat every week when they meet to make really like painfully slow type decisions about what to say in a book that mostly just one of them wrote alone anyway. In summary: be patient with Authors. You're here for right now but we're here every day after day after day getting everything write when we write and then ~~fuck~~ half your ~~shit~~ favorite stuff gets ~~redacted~~ cut out anyway. Sorry if that sounded mad. Didn't mean to. I promise. I love you. Stay with me. Sincerely, -J
