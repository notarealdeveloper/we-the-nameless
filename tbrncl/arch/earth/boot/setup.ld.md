...
Goto: [[main.c|Minutes of meeting on Genesis 1, and how the final version you know and maybe love came to be, as a result of the distinct personalities of these three[^2], and look up the Documentary Hypothesis if none of that made sense or more simply in summary: Welcome to We.]]
...
[^2]: And yes of course I'm aware that "three" should be "four" but give me some slack, it sounds better that way and who knows, maybe we started counting at zero, or maybe that three should just be two because it was mostly a disagreement that P had with me or hell maybe just one because hell in the end I mostly just let him have it cuz I wanted this relationship (or whatever that was) of ours to get off on the right foot which it didn't. In summary, be humble, lots of stuff can be right when you write right ok so when you didn't write it, maybe trust that the people who did made real painfully slow decisions about what to say. In summary, sorry if that sounded mad. Didn't mean to. I love you. Sincerely, -J.
