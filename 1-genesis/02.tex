...
\Def{Eden}{
(\textit{Sumerian}: \textit{eden}). 𓅭𓇳 Sumerian term meaning ``plain,'' ``steppe,'' or ``open uncultivated land,'' widely attested across Mesopotamian history in both phonetic and logographic forms.
}
