...
\Def{Eden}{
(\textit{Sumerian}: \textit{eden}, {\Cun 𓅭𓇳}). Sumerian term meaning ``plain,'' ``steppe,'' or ``open uncultivated land,'' widely attested across Mesopotamian history in both phonetic and logographic forms.
}
...
\DefC{PSHN}{
(Heb, \iheb{פשנ}).\\
A meaningless consonant cluster, appearing to be a misspelling of Pishon, with an orthogrgaphically invalid non-terminal Nun (\iheb{נ}), and an omission of the matres lectiones \iheb{י} and \iheb{ו}. It is unclear why this is being defined.
}
...
\DefC{Matres Lectiones}{
(Latin: \textit{matres lectionis}, ``mothers of reading'').\\
Consonant letters used to indicate vowels in Semitic writing systems. In Hebrew these are primarily \iheb{א}, \iheb{ה}, \iheb{ו}, and \iheb{י}. The latter two especially often function as vowel markers rather than full consonants. Their use helps disambiguate pronunciation in scripts that originally recorded mainly consonants.
Thus a form like \iheb{פשנ} may be viewed as a \textit{defective spelling} of something expected to include the matres \iheb{י} or \iheb{ו}, as in \iheb{פישון}. Similar phenomena occur across Hebrew, Aramaic, Syriac, Arabic, Phoenician, Moabite, South Arabian, and even Ugaritic orthographic traditions, and is especially frequent in older writing.
}

\Define{Matres Lectiones}
...
\DefC{Havilah}{
(Heb, \iheb{חוילה}).\\
Possibly related to roots for twisting, writhing, circling, labor pains, or linked chains (\iheb{חול}, \iheb{חיל}, \iheb{חוליה}); strongly serpent- and motion-themed imagery.
}
...
\Def{Gold}{
(Heb, \iheb{זהב}).\\
Cognate with Arabic \iarb{ذهب}, meaning both (1) ``gold,'' and (2) ``to go,'' ``depart,'' ``vanish,'' or ``pass away,'' potentially implying something exiting, moving on, or leaving.
}

\Def{Bdellium}{
(Heb, \iheb{בדלח}).\\
Possibly connected to roots meaning ``divide,'' ``separate,'' or ``scatter'' (\iheb{בדל}); imagery of fragmentation, distinction, or pieces.
}

\Def{Onyx}{
(Heb, \iheb{השהם}). Phonetically suggestive of \iheb{השם} (``The Name,'' i.e.\ Yahweh) and \iheb{אשם} (``guilt'' / ``guilt offering''), creating possible layered punning around divinity and culpability.
}
...
\Def{Gihon}{
(Heb, \iheb{גיחון}). One of Eden's rivers; likely echoes roots of bursting forth or belly-like swelling, and later reappears at Solomon's coronation spring in Jerusalem.
}
...
\Def{Kush}{
(Heb, \iheb{כוש}). Possibly evokes Semitic roots involving enclosure, concavity, stripping, or breaking; potentially punning with \iheb{כוס} (``cup,'' later vulgar sexual slang), fitting Eden's winding river imagery.
}
