...
}
{
	...
	\aB{
		Ok so now the books starts over with a completely different creation story.

		This one was written a couple hundred years earlier.

		In the beginning, this was the beginning.

		Now's not the beginning. So now it's not the beginning anymore.
		
		Let's keep moving. Lots of ground to cover.
	}
...
}
{
	...
	\aB{
		...
		This author says YHWH instead of God or Elohim or \heb{אלהים} or whatever.

		Now you might notice it says \eR{God} and \hR{אלהים} up there.

		Those \eJ{YHWH} \eR{God}
		\footnote{Or if you prefer, \hJ{יְהֹוָה} \hR{אלהים}.}
		things stop after a couple pages and it's just YHWH from then on.
	}
