...
{
	\eE{
		And Joseph answered Pharaoh, saying, “Not I. God will\\
...
{
%	\footnote{
%		scrawny. There is confusion in the wording in regard to both the ears of
%		grain and the cows, going back and forth between the word “thin” and the
%		word “scrawny” (see 41:3,4,19,20,27). This minor point is instructive
%		because it is a good example of a well-known scribal phenomenon, the
%		confusion of the letters dalet and resh, which looked similar in many
%		periods. The two words in Hebrew are (thin) and (scrawny). An error is
%		easily made. And the chance of error is increased because the word is
%		sometimes followed by (bad), and this alliteration further draws a
%		scribe’s eye to see a resh in place of a dalet.
%	}
}
...
{
%	\footnote{
%		conform. The verb here, which usually means “to kiss,” is a problem for
%		all translators. It may reflect a scribal problem or an idiom that is no
%		longer familiar to us.
%	}
}
...
%		an Egyptian term. One rabbinic interpretation takes it to mean “Bend the
%		knee.”
%	}
}
...
{
	\eE{
		And Pharaoh called Joseph’s name Zaphe-nath-paneah. And he\\
		gave him Asenath, daughter of Poti-phera, priest of On, as\\
...
\Verse{46}
{
	\hP{וְיוֹסֵף בֶּן שְׁלֹשִׁים שָׁנָה בְּעמְדוֹ לִפְנֵי פַּרְעֹה מֶלֶךְ מִצְרָיִם וַיֵּצֵא יוֹסֵף מִלִּפְנֵי פַרְעֹה וַיַּעֲבֹר בְּכל אֶרֶץ מִצְרָיִם׃}
}
{
	\eP{
		And Joseph was thirty years old when he stood in front of\\
		Pharaoh, king of Egypt. And Joseph went out from in front\\
		of Pharaoh and passed through all the land of Egypt.\\
	}
}
{
}
