...
\aB{
	...
	\footnote{
		The abruptness of the present reading has led many commentators to posit a lacuna in the text.
		Against this, it has been observed that the received form preserves the poem's alternating 
			aleph–taw structure—the systematic use of the first and last letters of the Hebrew 
		...
		According to this view, the work represents an ambitious, if incompletely understood,
			attempt to construct a modern orthography possessing all the syntactic, semantic,
		...
		An absolute majority of such scholars are simply forced to approach the text in translation.
	}
