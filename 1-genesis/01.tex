...
}
{
    ...
    \aB{
        ...
        \begin{quote}
        \aC{The word \hBP{אלהים} (Elhim) is a ``defective spelling'' of the word \hBP{אלוהים} (Elohim).}
        \end{quote}

        And if you look up that word, it says

        \begin{quote}
        \aC{The word \hBP{אלוהים} (Elohim) is from the plural of \hBP{אלוה} (Eloh) which means ``god.''}
        \end{quote}
        ...
        \begin{quote}
        \aC{Thus may prefer the term \hBP{אלוקים} (Elokim), so as not to abuse the name of God.}
        \end{quote}
