...
\aB{
    ...
    \begin{center}
    \eP{\textsc{We}} the Nameless

    \eP{\textsc{who wrought}}

    \eP{\textsc{the holy writ}}

    \eP{\textsc{of sacred scripture.}}
    \end{center}
    ...
    The ancient \eP{\textsc{ones, who wrote these words in the ancient days. For it is}}

    \begin{center}
    \eP{\textsc{We who wrote these sacred words,}}

    \eP{\textsc{to which nothing must be added,}}

    \eP{\textsc{and from which nothing may be taken away.}}
    \end{center}
    ...
    Anyone can write \eP{\textsc{a book. But a bible cannot be written. For it is}}

    \begin{center}
    \eP{\textsc{We who wrote the bible}}

    \eP{\textsc{the holy writ of sacred scripture}}
    ...
    \aR{of}
    \eP{\textsc{We}, the Nameless Authors of mystery,}

    \eP{who alone possess the secret}
    ...
    %That's us; \textsc{W}\eP{\textsc{e}, by} who\eP{m the} \aR{words of those who} wrote the bible \eP{was written.}

    And as anonymous as we may be

    Turns out we're humans too \eP{mysterious to name.}

    \eP{And too mysterious to understand.}
