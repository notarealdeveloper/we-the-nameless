...
\aB{
    ...
    \eP{to which nothing must be added,}

    \eP{and from which nothing may be taken away.}
    \end{center}
    ...
    Anyone can write \eP{a book. But a bible cannot be written. For it is}

    \begin{center}
    \eP{\textsc{We} who wrote the bible}

    \eP{the holy writ of sacred scripture}
