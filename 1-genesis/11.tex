...
{
	\eJ{
		11 And it was: all the earth was one language and the same\\
		words.\\
	}
}
{
...
\Verse{4}
{
	\hJ{וַיֹּאמְרוּ הָבָה נִבְנֶה לָּנוּ עִיר וּמִגְדָּל וְרֹאשׁוֹ בַשָּׁמַיִם וְנַעֲשֶׂה לָּנוּ שֵׁם פֶּן נָפוּץ עַל פְּנֵי כל הָאָרֶץ׃}
}
{
	\eJ{
		And they said, “Come on, let’s build ourselves a city and\\
		a tower, and its top will be in the skies, and we’ll make\\
		ourselves a name, or else we’ll scatter over the face of\\
		all the earth.”\\
	}
}
{
