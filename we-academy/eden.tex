...
% LuaLaTeX; relies on the Hebrew/font/source primitives defined in master.tex.
...
\hJ{ושם הנהר השני גיחון}

``And the name of the second river is Gihon.''

\hJ{ושם הנהר השלישי חדקל}

``And the name of the third river is Tigris.''

\hJ{והנהר הרביעי הוא פרת}
...
\begin{quote}
\hJ{הוא הסבב את כל ארץ החוילה}

but, for Gihon,

\hJ{הוא הסובב את כל ארץ כוש}.
\end{quote}
...
\begin{quote}
\hJ{אשר שם הזהב וזהב הארץ ההוא טוב שם הבדלח ואבן השהם}
\end{quote}
...
\begin{quote}
\hJ{שם \; הזהב \; וזהב \; הארץ \; ההוא \; טוב \; שם \; הבדלח \; ואבן \; השהם}
\end{quote}

A zero-edit alternative segmentation is:

\begin{quote}
\hJ{שם \; הזה \; בוזה \; בה \; ארצה \; הוא \; טוב \; שמה \; בדל \; חוא \; בן \; השה}
\end{quote}
...
``the name of this [one] \ldots''

or, if the surface boundary is momentarily retained,

\hJ{שם הזהב}

``the name of the gold \ldots'' / ``the name of the golden one \ldots''
\end{quote}
...
\begin{center}
\small
\begin{tabular}{p{0.12\linewidth}p{0.57\linewidth}p{0.21\linewidth}}
...
\begin{quote}
\hJ{טוב \; שם \; הבדלח \; ואבן}
\end{quote}

supports the alternative:

\begin{quote}
\hJ{טוב \; שמה \; בדל \; חוא \; בן}.
\end{quote}
...
\medskip
place/name/placing \quad -- \quad severed piece/separation \quad -- \quad life-associated \heb{חוא} \quad -- \quad offspring
\end{center}
...
\begin{quote}
\hJ{ומשם יפרד והיה לארבעה ראשים}

``and from there it divides, and it became four heads.''
\end{quote}
...
\begin{center}
\small
\begin{tabular}{p{0.15\linewidth}p{0.36\linewidth}p{0.38\linewidth}}
...
\begin{quote}
\hJ{כי ביום אכלך ממנו מות תמות}.
\end{quote}

Solomon warns Shimei in 1 Kings 2:37:

\begin{quote}
\hJ{והיה ביום צאתך ועברת את נחל קדרון ידע תדע כי מות תמות}.
\end{quote}
...
\begin{center}
\small
\begin{tabular}{p{0.12\linewidth}p{0.19\linewidth}p{0.19\linewidth}p{0.19\linewidth}p{0.20\linewidth}}
