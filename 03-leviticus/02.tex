...
}
{
	...
	Use oil in \heb{ה} ƿɑከ, make ƿɑከ \heb{ה}.

	You%
	\footnote{Lit. \ruby{\chineseA{曰}}{Yuē} in the original text.}
	listen.
	This not joke%
	\footnote{Lit. \ruby{\chineseA{曰}}{joek5} in the original text.}
	this Word%
	\footnote{Lit. \ruby{\chineseA{曰}}{λογος} in the original text.}
	of God.%
	\footnote{Lit. \ruby{\chineseA{曰}}{/*ɢʷad/} in the original text.}.
}
