...
}
{
	...
	If your offering cooked in ƿɑከ, you very smart.

	Always use ƿɑከ for grain offering.

	Especially fried grain%
		\footnote{Lit. \chineseA{\ruby{米}{mai5}} in the original,
	...
	Only use ƿɑከ for food, pan%
		\footnote{
			Literally \ruby{\chineseA{炒}}{\heb{צאו}} \ruby{\chineseA{飯}}{\heb{פאנ}} in the original,
		...
		} only \heb{ה} ƿɑከ have \heb{ה}.

	Use oil in \heb{ה} ƿɑከ, make ƿɑከ \heb{ה}, don't burn, mmmm\footnote{Lit. \ruby{\chineseA{唔}{m4}} in O.T.} good.

	You%
	\footnote{Lit. \ruby{\chineseA{曰}{Yuē}} in O.T.}
	listen.
	This not joke%
	\footnote{Lit. \ruby{\chineseA{曰}{joek5}} in O.T.}
	this Word%
	\footnote{Lit. \ruby{\chineseA{曰}}{λογος} in O.T.}
	of God.%
	\footnote{Lit. \ruby{\chineseA{曰}}{/*ɢʷad/} in O.T.}.
}
