...
{
	\aA{No turning back now.}

	\aB{Strap in folks.}

	\aC{Here we go.}

	And \aB{he} \aC{called}\footnote{Hey that's the name of the book.} to Drew from the Tent of Meeting.\fB{
...
{
	If you want to give YHWH some birds as a burning present,\fC{The original text shows ``House warming present'' struck out and replaced with ``burning present,'' perhaps a reference to the rejection of YHWH's application for ``A house for my name to dwell in.'' See the Exodus Apocrypha in the last book for details.} it has to be either:

	\begin{enumerate}
	\item Pigeons
	\item Turtledoves\footnote{Like the song.}
	\end{enumerate}
}
...
{
	Don't cut it in half. Remember Abraham when he cut those animals up?

	He didn't do the birds, right? Exactly.
