...
%	\endgroup
       ...
       \Table{|p{0.16\linewidth}|p{0.25\linewidth}|p{0.49\linewidth}|}{
                ...
                Judah & \heb{יְהוּדָה} (\emph{Yəhûdāh})
                        & The guy who started the jews.\fB{Version 1.} \\
                \hline
	...
	So anyways Judah leaves his other brothers and goes
...
}
{
	...
	She's the daughter\fB{Lit. \heb{בַּת}.} of a guy named Shua.\fB{Lit. \heb{שׁוּעַ}.}

	He took her and he came to her.
	
	Now she's pregnant, because ``come'' works like that.\fC{
		``Like that'' here presumably means ``maintaining both a standard meaning
		and a euphemistic meaning in parallel across multiple language families
		for something like 3000 years, with or without the different groups
		who use the term in said manner coming together for purposes of
		communication, co-marriage, common interests, or commerce,
		such as, for example, in agricultural societies, sharing seed.
	}
}
...
{
	She has a baby and calls it Er.\fA{Lit. {\Er} in the original.}
}
