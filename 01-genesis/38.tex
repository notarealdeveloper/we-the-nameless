...
}
{
	...
	She's the daughter%
	\fB{Lit. \paleo{בַּת}.} of a guy named Shua.%
	\fB{Lit. \paleo{שׁוּעַ}.}
...
}
{
	...
	She has a baby and calls it {\Er}.\fA{
...
{
	And Onan\fB{
		That's \paleo{אונן}, not \paleo{א}\hR{\paleo{מ}}\paleo{נון}.
	}
}
...
}
{
	...
	Shelah.\fB{
		That's \paleo{שלה}, not \paleo{של}\hR{\paleo{מ}}\paleo{ה}
	}
...
}
{
	...
	... that comment was from someone named R.A.
