...
{
	Then it says she called the name of ``YHWH who spoke to her.''

	So I guess we figured out who the messenger was.
	
	She says ``You are El-roi'' which is like ``The God who sees.''

	Then she says a phrase that translators can't seem to agree on the meaning of.
	...
	\item I definitely saw X's \redacted{ass} \eR{posterior}.
...
}
{
	...
	Don't blame Abe. He was looking at the story when she told him,
...
{
	Like c'mon, he's eighty.\aC{\footnote{And six.}} He's doing his best.
