...
}
{
	...
	So Abe and Keturah have some kids named Conflict and Gloom and Initiated and Dad Knows and God Knows,
	like ya do.

	Unrelated Note: Remember how Abe's new wife is named Keturah?

	Her name derives from the Hebrew root qatar (\heb{קטר}), which means ``to burn a sacrifice.''

	Don't worry about it.
	
	Isaac's fine.\aC{\footnote{
