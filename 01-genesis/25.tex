...
}
{
	...
	Has Abe been spreading seed in private?
}
...
}
{
	...
	And he was gathered to his people.\footnote{Side Note: They used to have family tombs in the ancient near east. They'd bury four generations together and then seal it up and start a new one. So ``gathered to his people'' means literally ``buried with his parents and grandparents.'' They're pretty spread out though, so maybe here it's a metaphor.}
}
...
%	}
	...
	P deletes the sacrifice.\footnote{We'll find out why eventually.}
...
{
	Toward the end he has a kid named ``So Many.''
...
}
{
	...
	\aC{
		Biblical Hebrew normally puts an unfinished verb before its subject and object: ``serve OLDER YOUNGER'' means ``the older will serve the younger.'' Here OLDER comes first: ``OLDER serve YOUNGER.'' That can still make OLDER the subject, but Hebrew can also front an object, making YOUNGER the subject. Both adjectives are masculine singular, and neither is marked as the object, so the words can mean either ``the older will serve the younger'' or ``the younger will serve the older.'' The traditional reading chooses the first; the Hebrew itself does not.
	}
...
}
{
	...
	He's called \paleo{𐤉𐤏𐤒𐤁} because he came out holding Esau's
	\paleo{𐤏𐤒𐤁}.
