...
}
{
	...
	And he was gathered to his people.\footnote{Side Note: They used to have family tombs in the ancient near east. They'd bury four generations together and then seal it up and start a new one. So ``gathered to his people'' means literally ``buried with his parents and grandparents.'' They're pretty spread out through, so maybe here it's a metaphor.}
}
...
}
{
	...
	And now the cave recieves Abe too, and this is the receipt of his receipt.
}
...
}
{
	...
	\Table{|p{0.18\linewidth}|p{0.16\linewidth}|p{0.56\linewidth}|}{
		...
		\textbf{Name} & \textbf{Hebrew} & \textbf{Meaning / likely etymology} \\
		\hline
		\textbf{Ishmael} & \heb{יִשְׁמָעֵאל} & ``El / God hears.'' \\
		\hline
		\textbf{Nebaioth} & \heb{נְבָיֹת} & Uncertain; probably an Arabian tribal name. \\
		\hline
		\textbf{Kedar} & \heb{קֵדָר} & ``Dark / swarthy,'' from \heb{קדר}, ``be dark.'' \\
		\hline
		\textbf{Adbeel} & \heb{אַדְבְּאֵל} & Probably ``disciplined / chastened by El''; uncertain. \\
		\hline
		\textbf{Mibsam} & \heb{מִבְשָׂם} & ``Fragrance / perfume / spice.'' \\
		\hline
	}
	\endgroup
}
...
}
{
	...
	\Table{|p{0.18\linewidth}|p{0.16\linewidth}|p{0.56\linewidth}|}{
		...
		\textbf{Name} & \textbf{Hebrew} & \textbf{Meaning / likely etymology} \\
		\hline
		\textbf{Mishma} & \heb{מִשְׁמָע} & ``Hearing / thing heard,'' from \heb{שמע}, ``hear.'' \\
		\hline
		\textbf{Dumah} & \heb{דּוּמָה} & ``Silence.'' \\
		\hline
		\textbf{Massa} & \heb{מַשָּׂא} & ``Burden / load,'' or possibly ``oracle / utterance.'' \\
		\hline
	}
	\endgroup
}
...
}
{
	...
	\Table{|p{0.18\linewidth}|p{0.16\linewidth}|p{0.56\linewidth}|}{
		...
		\textbf{Name} & \textbf{Hebrew} & \textbf{Meaning / likely etymology} \\
		\hline
		\textbf{Hadar} & \heb{חֲדַר} & Meaning uncertain; compare Hadad in some textual traditions. \\
		\hline
		\textbf{Tema} & \heb{תֵּימָא} & Arabian place/tribal name, Tayma; original meaning uncertain. \\
		\hline
		\textbf{Jetur} & \heb{יְטוּר} & Probably ``enclosure,'' or related to a root ``surround''; uncertain. \\
		\hline
		\textbf{Naphish} & \heb{נָפִישׁ} & Probably ``numerous / abundant''; compare Aramaic ``increase / spread.'' \\
		\hline
		\textbf{Kedmah} & \heb{קֵדְמָה} & ``Eastward / east,'' from \heb{קדם}. \\
		\hline
	}
	\endgroup
}
