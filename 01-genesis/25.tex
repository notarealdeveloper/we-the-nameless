...
{
	\aB{Third wife has a LOT of babies.}\aC{\footnote{One's name is Midian. Keep that in mind for later.}}

	Ok so, remember how right after the b\redacted{urn}ing of Isaac,
...
}
{
	...
	\Table{|p{0.18\linewidth}|p{0.16\linewidth}|p{0.56\linewidth}|}{
		...
		\textbf{Sheba}
			& \heb{שְׁבָא}
			& Uncertain ancient ethnonym; sometimes associated by wordplay with \heb{שבע},
				 ``seven / oath,'' but not securely. \\
		\hline
		\textbf{Dedan}
			& \heb{דְּדָן}
...
}
{
	...
	Her name derives from the Hebrew root qatar (\heb{קטר}), which means ``to burn a sacrifice.''

	Nothing to see here folks, don't worry about it, Isaac's fine.\aC{\footnote{
		In the sources in which he appears after Genesis 22, namely the non-E sources.
	}}
}
