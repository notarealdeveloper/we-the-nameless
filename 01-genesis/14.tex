...
{
    \eOther{\upshape\mdseries \textsc{Opposing Coalition}: Bera of Sodom; Birsha of Gomorrah; Shinab of
        Admah; Shemeber of Zeboiim; king of Bela (modern designation: Zoar).
        Hostilities commenced between the two coalitions.}
}
{
    \eOther{\upshape\mdseries Qere Ketiv.}
}
...
{
    \eOther{\upshape\mdseries \textsc{Assembly Point}: Valley of Siddim (modern designation: Dead Sea). The
...
{
    \eOther{\upshape\mdseries \textsc{Political Status}: Twelve years under Chedorlaomer. \textsc{Year 13}: western vassals revolted.}
}
{
...
{
    \eOther{\upshape\mdseries \textsc{Year 14}: Chedorlaomer and allied kings commenced punitive
...
{
    \eOther{\upshape\mdseries Horites struck throughout the hill country of Seir as far as El
...
{
    \eOther{\upshape\mdseries \textsc{Return Advance}: Coalition forces turned toward En Mishpat (modern
...
{
    \eOther{\upshape\mdseries \textsc{Western Response}: Kings of Sodom, Gomorrah, Admah, Zeboiim,
...
{
    \eOther{\upshape\mdseries \textsc{Order of Battle}: Chedorlaomer of Elam; Tidal of Goiim; Amraphel of
...
{
    \eOther{\upshape\mdseries \textsc{Terrain}: Valley of Siddim heavily broken by bitumen pits. \textsc{Result}:
...
{
    \eOther{\upshape\mdseries \textsc{Sodom and Gomorrah}: Coalition forces seized all movable property
...
{
    \eOther{\upshape\mdseries \textsc{Captives}: Lot, nephew of Abram
...
{
    \eOther{\upshape\mdseries \textsc{Survivor Report}: One escapee reached Abram the Hebrew, then encamped
        by the oaks of Mamre the Amorite. Mamre, Eshcol,
        and Aner were covenant allies of Abram.}
}
{
%    \footnote{
...
{
    \eOther{\upshape\mdseries \textsc{Mobilization}: Upon confirmation that his kinsman had been captured,
...
{
    \eOther{\upshape\mdseries \textsc{Night Action}: Abram divided his force, attacked with his retainers,
...
{
    \eOther{\upshape\mdseries \textsc{Recovery}: All seized property recovered. Lot
...
{
    \eOther{\upshape\mdseries \textsc{Return}: Following the defeat of Chedorlaomer
...
{
    \eOther{\upshape\mdseries \textsc{Salem}: Melchizedek, King of Salem
...
{
    \eOther{\upshape\mdseries \textsc{Blessing}: "Blessed be Abram by El Most High, Maker of heaven
        and earth;}
}
{
...
{
    \eOther{\upshape\mdseries and blessed be El Most High, who delivered your enemies into your
...
{
    \eOther{\upshape\mdseries \textsc{Sodomite Claim}: King of Sodom requested return of the persons; Abram
...
\Verse{22}
{
    \hOther{וַיֹּאמֶר אַבְרָם אֶל מֶלֶךְ סְדֹם הֲרִמֹתִי יָדִי אֶל יְהֹוָה אֵל
        עֶלְיוֹן קֹנֵה שָׁמַיִם וָאָרֶץ׃}
}
{
    \eOther{And Abram said to the king of Sodom, "I've lifted my hand to YHWH,
        El the Highest, creator of skies
        and earth,}
}
{
    \eOther{\upshape\mdseries \textsc{Abram---Oath}: "I have raised my hand to YHWH, El Most High, Maker of
        heaven and earth:}
}
{
...
\Verse{23}
{
    \hOther{אִם מִחוּט וְעַד שְׂרוֹךְ נַעַל
        וְאִם אֶקַּח מִכּל אֲשֶׁר לָךְ וְלֹא תֹאמַר אֲנִי הֶעֱשַׁרְתִּי אֶת
        אַבְרָם׃}
}
{
    \eOther{that, from a thread to a shoelace, I won't take anything that is
        yours, so you won't say, 'I made Abram rich.'}
}
{
    \eOther{\upshape\mdseries I will take neither thread nor sandal strap nor anything belonging
        to you, so that no claim may be made that the King of Sodom enriched
        Abram.}
}
{
...
{
    \eOther{\upshape\mdseries \textsc{Exceptions}: provisions already consumed by Abram's men; contractual
