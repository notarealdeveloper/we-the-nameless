...
OW ARE RENDERED UNTO ASH

\& THEIR SEED IS NO MORE.
}
\end{center}
...
}
{
    \eOther{And it was in the days of Amraphel, king of Shinar, Arioch, king of
        Ellasar, Chedor-laomer, king of Elam,
        and Tidal, king of Goiim:4}
}
{
    \eOther{
        REGNAL YEAR: unspecified.

        THEATER: Jordan Valley.

        EASTERN COALITION: Amraphel of Shinar; Arioch of Ellasar; Chedorlaomer of Elam; Tidal of Goiim.
    }
}
{
...
{
    \eOther{OPPOSING COALITION: Bera of Sodom; Birsha of Gomorrah; Shinab of
...
{
    \eOther{ASSEMBLY POINT: Valley of Siddim (modern designation: Dead Sea). The
...
{
    \eOther{Twelve years they served Chedorlaomer,
        and the thirteenth year they revolted,}
}
{
    \eOther{POLITICAL STATUS: Twelve years under Chedorlaomer. YEAR 13: western
        vassals revolted.}
}
{
...
{
    \eOther{YEAR 14: Chedorlaomer and allied kings commenced punitive
...
{
    \eOther{Horites struck throughout the hill country of Seir as far as El
...
{
    \eOther{RETURN ADVANCE: Coalition forces turned toward En Mishpat (modern
...
{
    \eOther{WESTERN RESPONSE: Kings of Sodom, Gomorrah, Admah, Zeboiim,
...
{
    \eOther{ORDER OF BATTLE: Chedorlaomer of Elam; Tidal of Goiim; Amraphel of
        Shinar; Arioch of Ellasar. STRENGTH: four kings against five.}
}
{
...
{
    \eOther{TERRAIN: Valley of Siddim heavily broken by bitumen pits. RESULT:
...
{
    \eOther{SODOM AND GOMORRAH: Coalition forces seized all movable property
...
{
    \eOther{CAPTIVES: Lot, nephew of Abram
...
{
    \eOther{SURVIVOR REPORT: One escapee reached Abram the Hebrew, then encamped
...
{
    \eOther{MOBILIZATION: Upon confirmation that his kinsman had been captured,
        Abram mustered 318 trained household-born retainers. PURSUIT: north to
        Dan.}
}
{
...
{
    \eOther{NIGHT ACTION: Abram divided his force, attacked with his retainers,
...
{
    \eOther{RECOVERY: All seized property recovered. Lot
...
{
    \eOther{RETURN: Following the defeat of Chedorlaomer
...
{
    \eOther{SALEM: Melchizedek, King of Salem
...
{
    \eOther{BLESSING: "Blessed be Abram by El Most High, Maker of heaven
        and earth;}
}
{
...
{
    \eOther{and blessed be El Most High, who delivered your enemies into your
        hand." TRIBUTE: Abram transferred one tenth of all recovered goods to
        Melchizedek.}
}
{
...
{
    \eOther{SODOMITE CLAIM: King of Sodom requested return of the persons; Abram
...
{
    \eOther{ABRAM---OATH: "I have raised my hand to YHWH, El Most High, Maker of
        heaven and earth:}
}
{
...
{
    \eOther{I will take neither thread nor sandal strap nor anything belonging
...
{
    \eOther{EXCEPTIONS: provisions already consumed by Abram's men; contractual
