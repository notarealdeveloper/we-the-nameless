...
{
	\eRJE{
		And an angel of YHWH\eRB{\footnote{Fourth of five. This one's above my pay grade.}} called to him from the skies
...
}
{
	...
	\aA{They call the kids Advice and Hated and God Came Up, the third of which had a kid called Up.}
}
...
}
{
	...
	\aA{and Mercy and Look and Flame Of Fire and He's Crying\fB{Wait are these names dogwhistles about burning Isaac?} and House Of God.}
}
...
}
{
	...
	\aA{And House Of God gave birth to Binding.\fB{Hello!?}}

	\aA{Queen had these eight kids for Snorting, Abe's brother.}
}
...
}
{
	...
	\aA{Oh and also he had an unofficial wife named Go Up, she had kids too.}

	\aA{Their names were
		Slaughter\fB{Name Him Slaughter?!} and
		Burning\fB{Is anyone else seeing this!?}
		and Quickly\fB{Or Leather Skin.} and
		Crushing Oppression.\fB{Where's Isaac?!}
	}
}
