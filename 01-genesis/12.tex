...
{
	Ok so there's this guy named Abram who was apparently introduced at the end of the previous begat list.

	YHWH tells him to leave home and go somewhere.
	
	He hasn't decided where yet.
%	\footnote{
...
{
	He promises to make him famous, and make his name famous too.
}
...
{
	He promises a lot actually.
	
	Your friends will be my friends.
	
	Your enemies will be my enemies.

	And all the families of the earth from all the other languages countries, they're gonna be blessed too.%
...
\Verse{4}
{
	\hJ{וַיֵּלֶךְ אַבְרָם כַּאֲשֶׁר דִּבֶּר אֵלָיו יְהֹוָה וַיֵּלֶךְ אִתּוֹ לוֹט וְאַבְרָם בֶּן חָמֵשׁ שָׁנִים וְשִׁבְעִים שָׁנָה בְּצֵאתוֹ מֵחָרָן׃}
}
{
	\eJ{
		And Abram went as YHWH had spoken to him, and Lot went
