...
}
{
    ...
    \aB{
        According to \textsc{TDRWFEROTMSOHK}%
        ...
        \begin{quote}
        \aC{The word \heb{אלהים} (Elhim) is a ``defective spelling'' of the word \heb{אלוהים} (Elohim).}
        \end{quote}

        And if you look up that word, it says

        \begin{quote}
        \aC{The word \heb{אלוהים} (Elohim) is from the plural of \heb{אלוה} (Eloh) which means ``god.''}
        \end{quote}

        And if you look around for some clarification, you'll find sentences like

        \begin{quote}
        \aC{This word is sometimes grammatically plural and sometimes singular.}
        \end{quote}

        And you may also stumble upon a sentence mentioning that particularly devout believers

        \begin{quote}
        \aC{Thus may prefer the term \heb{אלוקים} (Elokim), so as not to abuse the name of God.}
        \end{quote}

		And so we're off to a pretty weird start
    }
}
...
}
{
    \aB{
        ...
        And so it turns out the earth was already around when this Elohim character started creating it.

		Which is the reason for the ``had been'' in this line.

		That grammar is there in the original Hebrew too.
...
{
    \eP{And God said, “Let there be light.” And there was light.}
}
{
    ...
    \aB{
        ...
        That's not a surprise. At least to us authors.
...
{
    \aB{
        Then after he creates light, he decides he did a good job.
...
{
    \aB{
        Ok so he names the light.

        And the dark light that he cleaned out of the original light.

        He calls them day and night.

        \hspace{1em}Now remember, words create stuff.

        \hspace{2em}So immediately he's affected by his decision

        \hspace{3em}and suddenly it's day two.

        \hspace{2em}So it's like if you ``invent murder.''

        \hspace{1em}Now suddenly there's a dead body, cuz obviously.
...
{
    \aB{
        ... it's not super clear what's going on here yet, but he says some words.
    }
}
...
{
    \aB{
        So it seems like the words didn't create the stuff this time.

        He said ``Let there be a thing,'' but he still has to make the thing.

        Now he takes some of the water and moves it up.
        
        He just sort of pushes it up, above the other water.

        So the ``up water'' is the sky.

        Now wait, that's not as dumb as it sounds. After all:

        \begin{enumerate}
        \item It's blue up there, and
        \item Sometimes water comes down.
        \end{enumerate}

        So we must live in a middle bit between the ``up water'' and the ``down water.''

        All completely reasonable so far.
    }
}
...
}
{
    ...
    \aB{
        ...
        And there's still no land.%
        \footnote{He'll get to that soon.}

        Also the day ends before he got a chance to say ``it was good.''%
        \footnote{Hopefully he'll say it twice tomorrow and get back on schedule.}
    }
}
...
}
{
	% NHS NHS NHS
    \aB{
        Now he moves some of the down water.\nl
        Horizontally or whatever.\nl
        So it all piles up in one place.\nl
        Now the land appears.\nl
        He didn't make the land, it's been there since line two.\nl
        So nothing's getting created exactly.\nl
        Not created ``ex nihilo'' that is, out of nothing.\nl
        He's mostly just moving stuff around.\nl
        Sort of like we do when we create something.
    }
}
...
}
{
    ...
    \aB{
        ...
        So now He calls the pile of water over there ``seas''

        And the land over here is ``earth.''

        And it's the same Hebrew word as the first line.

        Hebrew calls it \heb{ארץ} (arts).
...
{
    \aB{
                At this point he decides to make two big sky balls.
                ...
                I guess that was hard before now.

                The sky balls are for ``appointed times.''

                Like holidays and stuff.
                
                Or like dinner time and bed time.
				...
				So Yin's associated with the moon, and Yang's associated with stuff like this
				(%
				...
				The more universal a thing is, the more ``bible'' it is.

				The more parochial a thing is, the less ``bible'' it is.

				By universal, I mean a thing that's true for humans in all times and all places.
				
				At least all times and places in human history and human now.
                ...
                \footnote{
                    ...
                    %is clear as crystal.
                }\xdef\fnseat{\thefootnote}
                through the center of the spread wide apart area\textsuperscript{\fnstreet}

                And from the center of the seat\textsuperscript{\fnseat}
                ...
                And then if they continued all like
                ...
                We'd be like ``Son of a... man, I mean Jesus Christ come on we got it.''
                
                And then if they're all like

                \begin{quote}
                Blessed are those who wash their robes
                \end{quote}

                We'd be like ``Ok really this is a bit much.''
                
                And then if they contined all like
                ...
                We'd be like ``Sorry didn't follow that could you back up and explain a bit?''

                And then if they didn't catch the obvious sarcasm and actually backed up and went
                ...
                \raisebox{-0.666pt}{ex}%
                \raisebox{+0.000pt}{t.}{%
                    \aP{\footnote{\scriptsize\RaggedRight%\bf
...
\aB{
    ...
    The ancient \aP{ones, who wrote these words in the ancient days. For it is}

    \begin{center}
    \aP{\textsc{We} who wrote these sacred words,}

    \aP{to which nothing must be added,}

    \aP{and from which nothing may be taken away.}
    \end{center}
    ...
    Anyone can write \aP{a book. But a bible cannot be written. For it is}

    \begin{center}
    \aP{\textsc{We} who wrote the bible}

    \aP{the holy writ of sacred scripture}
    ...
    \aR{of}
    \aP{\textsc{We}, the Nameless Authors of mystery,}

    \aP{who alone possess the secret}
    ...
    %That's us; \textsc{W}\aP{\textsc{e}, by} who\aP{m the} \aR{words of those who} wrote the bible \aP{was written.}

    And as anonymous as we may be

    Turns out we're humans too \aP{mysterious to name.}

    \aP{And too mysterious to understand.}
    ...
    To explain succinctly, it goes like this:%
	    ...
	    \hangingfootnote[2em]{
	        ...
	        The abruptness of the reading at this point has led many commentators to posit
