...
}
{
    \aB{
		...
		That odd grammar is there in the original Hebrew too.
...
{
    \eP{And {\God} said, “Let there be light.”\nl
		And there was light.}
}
{
    ...
    \aB{
        ...
        \footnote{The other readers need to be reminded.}%

        Just make a note of that and let's keep moving.%
        \footnote{Readers often forget the bible was written by an author. Or rather, several.}%
    }
}
