...
}
{
    \aB{
        ...
        \hspace{2em}So immediately he's affected by this decision of his

        \hspace{3em}and suddenly it's day two.

        \hspace{2em}So it's like if you ``invent murder'' and

        \hspace{1em}Now suddenly there's a dead body there, cuz obviously.
...
}
{
    ...
    \aB{
        ...
        And it's Hebrew word as the first line.
