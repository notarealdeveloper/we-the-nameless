...
}
{
	...
	\fC{\noindent\begin{minipage}{\linewidth}
		...
		\centering
		\includegraphics[width=0.90\linewidth]{img/brick.png}
		\vspace{-0.75\baselineskip}
		\end{wrapfigure}
...
}
{
	...
	let's%
	\fC{
	Yhwh uses the first-person plural here, as in Genesis 1:26 and 3:22,
	probably addressing the divine council of heavenly beings. Compare
	Genesis 6, Deuteronomy 32:8--9, and Psalm 82.
	}
