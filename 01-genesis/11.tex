...
}
{
	...
	point.%
	\fC{\noindent\begin{minipage}[t]{\dimexpr\linewidth-1.8em\relax}
		...
		\centering
		\includegraphics[width=0.90\linewidth]{\ifConfigKDPOn\KDPAssetDir/brick.png\else img/brick.png\fi}
		\vspace{-0.75\baselineskip}
		\end{wrapfigure}
...
}
{
	...
	\aC{
		...
		That little bastard in the picture is like 48 cents!

		We can build anything now, and make the rocks ourselves.

		Just make them, out of dirt.

		The days of wasting all our time looking for good rocks are over.

		All we need is people, enough people to build the thing.

		And we have everyone.

		We're never gonna run out of dirt!

		Just need enough bricks, god damn I love bricks.

		These little bastards are gonna solve all our problems team.

		Just think of what we could build if we work together.
