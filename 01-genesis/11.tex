...
{
	\aC{
		The family's history begins with an unexpected death.
	}
}
...
{
	\aC{
		The principal members of the family are now introduced.
	}
}
...
{
	\aC{
		This brief notice establishes the central tension of the
		patriarchal narrative before the promises are ever spoken.
	}
}
...
{
	\aC{
		The migration toward Canaan begins under Terah rather than
		Abram.
	}
}
...
{
	\aC{
		With Terah's death, the genealogy yields to the story of
		Abram.
	}
}