...
}
{
	...
	I'll bring you back up after.\fA{Don't worry about how.}
...
{
	\aB{That's just Leah's kids.}

	\aB{She had all those sons, and then she had Dinah.}
}
...
}
{
	...
	\aB{Gad's sons are Look Out, Party, Šunny, I'm Gonna Be Huge,\fB{Lit. I will be enlargement.} Awake, A Wild Ass, and Lionel.}
...
}
{
	...
	\aB{Asher's seed was Right Hand, Jesus, Jesus, Uh Oh, Too Much, Companion,\fB{Lit. Com\heb{פני}on} and MLK/king God.}
}
...
{
	\eP{
		These were the sons of Zilpah, whom Laban gave to Leah,
		his daughter, and she gave birth to these for Jacob,
		sixteen persons.
	}
}
{
	\aB{That was Zilpah's kids and grandkids.}
}
...
{
	\aB{Rachel had Joseph and Benjamin.}
}
...
}
{
	...
	\aB{Joseph married Some Egyptian, daughter of Rathaniel, priest of An and she had}

	\aC{\heb{נשה}}

	\aB{Made me Forget; Two Fruits.}
}
...
{
	\aB{That was Rachel's grandkids.}
}
...
}
{
	...
	\aB{Dan had a kid. His name was Hurry.}
}
...
}
{
	...
	\aB{Mein Kamph's sons are God Segregates, Colored, Yessir, and Reparations.}
}
...
{
	\aB{All 66 of those people came out of Jacob's \heb{ירך}.}\fC{
		This is the term for where Jacob was struck by his
		opponent during the wrestling match in Gen. 32.
	}
}
...
{
	\aB{
		Joseph had two kids in Egypt.

		That's it, end of list, seventy people.
...
}
{
	...
	Judah goes ahead to show them the way to Dirt Pile.
}
...
{
	Joseph drives up to meet dad at Dirt Pile.

	Then he hugs him and cries.
}
...
{
	Joseph's like ``I'm gonna go tell Pharaoh my family's here.''
}
...
{
	And I'll tell him they brought their sheep because they're sheep
	people and they brought their sheep and cows and everythi---

	\aC{
		Joseph now realizes something, which the text doesn't
		mention yet. But imagine him pausing here and looking
		concerned. That'll make sense in a minute.
	}
}
...
}
{
	...
	Hey guys, when he asks you what your job is...
}
...
{
	Say you're livestock people.

	Never say you're sheep people ok?

	He might not let you live here if you do.

	... Egyptians hate sheep people.
