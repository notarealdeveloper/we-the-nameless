...
}
{
	...
	He\fB{Who?!} says ``I won't let you go until you bless me.''%
	\fC{
		``Bless'' is \textit{b-r-k} (\heb{ברך}), the same consonantal root as
		\textit{berek}, knee.'' The root can also mean to kneel or bow, and the
		plural ``knees'' can mean the lap---the space formed by the knees when
...
}
{
	...
	And that's why \paleo{ישראל} is the name we say\footnote{
	\fC{
	...
	\begingroup
		...
		\begin{tabular}{@{}p{0.4875\linewidth}@{\hspace{0.025\linewidth}}p{0.4875\linewidth}@{}}
			...
			\begin{minipage}[t]{\linewidth}
				\vspace{0pt}
				\Table{lll}{
					\hJM{יֵאָמֵר}		& \trM{yēʾāmēr}		& will be said / called \\
					\hJM{עוֹד}			& \trM{ʿōḏ}			& anymore \\
					\hJM{שִׁמְךָ}		& \trM{šimḵā}		& your name \\
					\hJM{כִּי}			& \trM{kî}			& but \\
					\hJM{אִם}			& \trM{ʾim}			& rather \\
					\hJM{יִשְׂרָאֵל}	& \trM{yiśrāʾēl}	& Israel \\
					\hJM{כִּי}			& \trM{kî}			& because \\
					\hJM{שָׂרִיתָ}		& \trM{śārîṯā}		& you struggled \\
					\hJM{עִם}			& \trM{ʿim}			& with \\
					\hJM{אֱלֹהִים}		& \trM{ʾĕlōhîm}		& God / gods \\
					\hJM{וְעִם}			& \trM{wəʿim}		& and with \\
					\hJM{אֲנָשִׁים}		& \trM{ʾănāšîm}		& men / people \\
					\hJM{וַתּוּכָל}		& \trM{wattûḵāl}	& and you were able \\
				}
			\end{minipage}
		\end{tabular}
...
{
	So Jacob asks him\footnote{
		Lit. ``Jacob Is\redacted{r}aels him'' in the original Eng. and Heb.%
	} what his \paleo{שמ} is.

	He says Why do you ask my \paleo{שמ}?

	No answer, and he blesses\footnote{
