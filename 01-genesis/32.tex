...
\Verse{21}
{
	...
	\hE{\hlB{פָנ}}
	\hE{ָיו בַּמִּנְחָה הַהֹלֶכֶת לְ}
	\hE{\hlB{פָנ}}
	\hE{ָי וְאַחֲרֵי כֵן אֶרְאֶה}
	\hE{\hlB{פָנ}}
	\hE{ָיו אוּלַי יִשָּׂא}
	\hE{\hlB{פָנ}}
	\hE{ָי׃}
}
{
...
\Verse{22}
{
	...
	\hJ{\hlB{פָּנ}}
	\hJ{ָיו וְהוּא לָן בַּלַּיְלָה הַהוּא בַּמַּחֲנֶה׃}
}
{
	\eJ{
...
}
{
	...
	Then he crosses the Jabbok.\footnote{
		Jaboq (more commonly spelled Jabbok or Jabok; Hebrew: \heb{יַבֹּ}ק)
...
}
{
	...
	His etymology is wrong.

	Nobody knows why this line is here.%
	\fC{
...
{
	\aB{Deliverance!}\fC{
		The root \heb{נ־צ־ל} has the basic sense of taking away,
		stripping away, or pulling something out from somewhere.
		Thus “my life has been delivered” can carry the more
		concrete sense that Jacob’s life was pulled out or
