...
\Verse{22}
{
	\hE{וַתַּעֲבֹר הַמִּנְחָה עַל }
	\hE{\hlB{פָּנָיו}}
	\hE{ וְהוּא לָן בַּלַּיְלָה הַהוּא בַּמַּחֲנֶה׃}
}
{
	\eE{
...
\Verse{23}
{
	\hE{וַיָּקָם בַּלַּיְלָה הוּא וַיִּקַּח אֶת שְׁתֵּי נָשָׁיו וְאֶת שְׁתֵּי שִׁפְחֹתָיו וְאֶת אַחַד עָשָׂר יְלָדָיו וַיַּעֲבֹר אֵת מַעֲבַר יַבֹּק׃}
}
{
	\eE{
...
\Verse{24}
{
	\hE{וַיִּקָּחֵם וַיַּעֲבִרֵם אֶת הַנָּחַל וַיַּעֲבֵר אֶת אֲשֶׁר לוֹ׃}
}
{
	\eE{
...
}
{
	...
	\fC{
		In Gen.~32:26, ``dislocated'' is \textit{wattēqaʿ} (\heb{ותקע}),
		from \textit{t-q-ʿ} (\heb{תקע}), a remarkably broad verb meaning
...
}
{
	...
	\fC{
		...
		\eRB{called} (4 each), commands and resolved (3 each); answer, ask,
		\eRB{call}, continued, decided, declared, follows, gave an order, gave
