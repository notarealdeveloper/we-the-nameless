	...
	\begingroup
		...
		\begin{tabular}{@{}p{0.4875\linewidth}@{\hspace{0.025\linewidth}}p{0.4875\linewidth}@{}}
			\begin{minipage}[t]{\linewidth}
				\vspace{0pt}
				\Table{lll}{
					\hJM{וַיֹּאמֶר}	& \trM{wayyōmer}		& and he said \\
					\hJM{שַׁלְּחֵנִי}	& \trM{šalləḥēnî}		& let me go \\
					\hJM{כִּי}			& \trM{kî}				& because \\
					\hJM{עָלָה}			& \trM{ʿālā}			& has risen \\
					\hJM{הַשָּׁחַר}		& \trM{haššaḥar}		& the dawn \\
				}
			\end{minipage}
			&
			\begin{minipage}[t]{\linewidth}
				...
				\Table{lll}{
					\hJM{וַיֹּאמֶר}		& \trM{wayyōmer}		& and he said \\
					\hJM{לֹא}			& \trM{lōʾ}				& not \\
					\hJM{אֲשַׁלֵּחֲךָ}	& \trM{ʾăšallēḥăḵā}		& I will let you go \\
					\hJM{כִּי}			& \trM{kî}				& except \\
					\hJM{אִם}			& \trM{ʾim}				& if \\
					\hJM{בֵּרַכְתָּנִי}	& \trM{bēraḵtānî}		& you bless me \\
				}
			\end{minipage}
		\end{tabular}
	...
	\begingroup
		...
		\begin{tabular}{@{}p{0.4875\linewidth}@{\hspace{0.025\linewidth}}p{0.4875\linewidth}@{}}
			\begin{minipage}[t]{\linewidth}
				...
				\Table{lll}{
					\hJM{וַיֹּאמֶר}	& \trM{wayyōmer}	& and he said \\
					\hJM{אֵלָיו}		& \trM{ʾēlāw}		& to him \\
					\hJM{מַה}			& \trM{mah}			& what \\
					\hJM{שְּׁמֶךָ}		& \trM{šəmeḵā}		& your name \\
				}
			\end{minipage}
			&
			\begin{minipage}[t]{\linewidth}
...
}
{
	...
	\fC{
		...
		\begin{itemize}
			...
			\item ``declared'' (2)
			\item ``follows'' (2)
			\item ``gave an order'' (2)
			\item ``gave the order'' (2)
			\item ``gave orders'' (2)
			\item ``intend'' (2)
			\item ``namely'' (2)
			\item ``proposing'' (2)
			...
			\item ``telling'' (2)
			\item ``thinking'' (2)
			\item ``address,'' ``advised,'' ``answers,'' ``asking,'' ``Asserting,''
			``assigned,'' ``command,'' ``commanded to say,'' ``consider,''
			``declare*,'' ``declared*,'' ``declares,'' ``demonstrates,''
			``designate,'' ``desired,'' ``indeed say,'' ``informed,'' ``intended,''
			``intending,'' ``meditate,'' ``mentioned,'' ``name,'' ``news,''
			``plainly says,'' ``really thought,'' ``repeated*,'' ``replied*,''
			``requested,'' ``saying*,'' ``sent word,'' ``speak to you saying,''
			``specifically say,'' ``specified,'' ``still say,'' ``suppose,''
	...
	\begingroup
		...
		\begin{tabular}{@{}p{0.4875\linewidth}@{\hspace{0.025\linewidth}}p{0.4875\linewidth}@{}}
			...
			\begin{minipage}[t]{\linewidth}
				\vspace{0pt}
				\Table{lll}{
					\hJM{יֵאָמֵר}		& \trM{yēʾāmēr}		& he says \\
					\hJM{עוֹד}		& \trM{ʿōḏ}			& again / still / further \\
					\hJM{שִׁמְךָ}		& \trM{šimḵā}		& your name \\
					\hJM{כִּי}		& \trM{kî}			& but / rather / for / because \\
					\hJM{אִם}		& \trM{ʾim}			& if \\
					\hJM{יִשְׂרָאֵל}		& \trM{yiśrāʾēl}	& Israel \\
					\hJM{כִּי}		& \trM{kî}			& for / because \\
					\hJM{שָׂרִיתָ}		& \trM{śārîṯā}		& you contended / struggled \\
					\hJM{עִם}		& \trM{ʿim}			& with \\
					\hJM{אֱלֹהִים}		& \trM{ʾĕlōhîm}		& gods / God / a god \\
					\hJM{וְעִם}		& \trM{wəʿim}		& and with \\
					\hJM{אֲנָשִׁים}		& \trM{ʾănāšîm}		& men / people \\
					\hJM{וַתּוּכָל}		& \trM{wattûḵāl}	& and you were able / prevailed \\
				}
			\end{minipage}
		\end{tabular}
...
}
{
	So Jacob asks\fC{
		...
		largely by context:
		a \textit{š-ʾ-l} can be a neutral question, an inquiry, a request, an
		entreaty, or a demand.
		...
		\heb{שאל} is unstated. The following \textit{``Tell, please, your name''}
		makes an inquiry/request concerning the name the obvious contextual
		connection, but ``him'' is supplied by translators rather than expressed
		...
		heard more weakly as ``Jacob asked/inquired'' or more strongly as
		``Jacob requested/petitioned/entreated,'' without specifying in the verb
		...
		\textit{``Why is this that you \heb{שאל} for my name?''} Thus the scene
		turns twice on a verb capable of ranging from a simple question through
		inquiry and request to petition, entreaty, or demand, while the first
		occurrence conspicuously leaves its object unexpressed.

	} him\footnote{
		Lit. ``Jacob begs him'' in the original text.%
	}.
	...
	\begingroup
		...
		\begin{tabular}{@{}p{0.4875\linewidth}@{\hspace{0.025\linewidth}}p{0.4875\linewidth}@{}}
			\begin{minipage}[t]{\linewidth}
				...
				\Table{lll}{
					\hJM{וַיֹּאמֶר}	& \trM{wayyōmer}	& and he said \\
					\hJM{הַגִּידָה}		& \trM{haggîḏā}		& tell \\
					\hJM{נָּא}			& \trM{nnā}			& please \\
					\hJM{שְׁמֶךָ}		& \trM{šəmeḵā}		& your name \\
				}
			\end{minipage}
			&
			\begin{minipage}[t]{\linewidth}
				...
				\Table{lll}{
					\hJM{וַיֹּאמֶר}	& \trM{wayyōmer}	& and he said \\
					\hJM{לָמָּה}		& \trM{lāmmā}		& why \\
					\hJM{זֶּה}			& \trM{zeh}			& this \\
					\hJM{תִּשְׁאַל}		& \trM{tišʾal}		& you ask / inquire \\
					\hJM{לִשְׁמִי}		& \trM{lišmî}		& for my name \\
					\hJM{וַיְבָרֶךְ}	& \trM{wayḇāreḵ}	& and he blessed \\
					\hJM{אֹתוֹ}			& \trM{ʾōṯô}			& him \\
					\hJM{שָׁם}			& \trM{šām}			& there \\
				}
			\end{minipage}
		\end{tabular}
