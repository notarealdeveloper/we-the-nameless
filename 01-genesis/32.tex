...
\Verse{21}
{
	\hE{וַאֲמַרְתֶּם גַּם הִנֵּה עַבְדְּךָ יַעֲקֹב אַחֲרֵינוּ כִּי אָמַר אֲכַפְּרָה \hlB{פָנָיו} בַּמִּנְחָה הַהֹלֶכֶת \hlB{לְפָנָי} וְאַחֲרֵי כֵן אֶרְאֶה \hlB{פָנָיו} אוּלַי יִשָּׂא \hlB{פָנָי}׃}
}
{
	\eE{
		and you’ll say, ‘Here is your servant, Jacob, behind us as
		well.’” Because he said, “Let me appease \hlB{his face} with the
		offering that’s going \hlB{in front of me}, and after that I’ll
		see \hlB{his face}; maybe he’ll raise \hlB{my face}.”
	}
}
{
	He prepares to face his brother.\footnote{
		The word ``\hlB{face}'' (\hlB{\heb{פנים}}) saturates the episode,
		occurring five
		times in this sentence alone. Later, he says he's seen God
		``\hlB{face} to \hlB{face},'' and finally tells Esau that seeing his
		\hlB{face} is like seeing God's (33:10).
	}
%	\footnote{
...
\Verse{22}
{
	\hJ{וַתַּעֲבֹר הַמִּנְחָה עַל \hlB{פָּנָיו} וְהוּא לָן בַּלַּיְלָה הַהוּא בַּמַּחֲנֶה׃}
}
{
	\eJ{
...
}
{
	...
	which is presumably why he skips Dinah.\footnote{Sic?}
...
{
	Ok so Jacob is now all by himself.

	And he wrestles with a man%
