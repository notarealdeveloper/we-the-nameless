...
{
	So now he's cursed from the ADMH (\heb{אֲדָמָה}) too.
...
}
{
	...
	\Def{Nod}[\heb{נוֹד}; \textit{nōḏ}]{
		``Wandering.'' The symbolic land east of Eden where Cain settles after
		his exile (Gen.~4:16), named as a play on \heb{נוּד} (\textit{nûḏ}, ``to wander'').
		It occurs only here as a place name.
	}
...
\Verse{17}
{
	...
	\hJ{\hlC{יָדַע}}
	\hJ{\hlB{קַיִן}}
	\hJ{אֶת אִשְׁתּוֹ וַתַּהַר וַתֵּלֶד אֶת חֲנוֹךְ וַיְהִי בֹּנֶה עִיר וַיִּקְרָא שֵׁם הָעִיר כְּשֵׁם בְּנוֹ חֲנוֹךְ}
}
{
	\eJ{
...
{
	So then the Redactor shows up.	
	
	He needs solve a problem we haven't gotten to yet.

	Next up is a begat list, let's keep moving.	
}
