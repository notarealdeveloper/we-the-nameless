...
}
{
	...
	Also notice up in the first line how the noun \paleo{אדמ} comes before the verb \paleo{יָדַע}.

	And whenever that happens in biblical hebrew, it's the past tense plus the perfect aspect.

	And as you know, we didn't know how to read the past perfect in biblical hebrew until the 1970s.
...
}
{
	...
	\footnote{
		...
		\subfootnote{A thousand wives will do that to you, according to some scholars.}%
	}
...
}
{
    ...
    \Def{Genesis 4:7: A Difficult Verse}[Genesis 4:7]{

        \aC{
            Genesis 4:7 is one of the most difficult sentences in the Hebrew
            Bible. Almost every translation makes different choices because
            several ordinary Hebrew words have unusually broad meanings.
        }
        ...
        \aC{
            The uncertainty extends beyond individual words. As we will see
            throughout this book, there are passages whose very genre remains
            debated. Is a text meant to be read literally, symbolically,
            poetically, satirically, or as something else entirely? Such
            questions cannot always be answered from the words alone. They
            depend on understanding what the authors were trying to accomplish.
            More than perhaps any other ancient work, the Hebrew Bible gives
            the impression that its authors were always ``up to something.''
            Discovering what that ``something'' was is a question that must
            often be answered one passage at a time.
        }
