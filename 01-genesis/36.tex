...
}
{
	...
	\Table{|p{0.16\linewidth}|p{0.25\linewidth}|p{0.49\linewidth}|}{
		...
		\hline
		Seir & \heb{שֵׂעִיר} (\emph{Śēʿîr}) & Closely related to \heb{שֵׂעִיר/שֵׂעָר}, “hairy, shaggy / hair.” \\
		\hline
		Edom & \heb{אֱדוֹם} & “Red.” \\
		\hline
	}
...
}
{
	...
	\Table{|p{0.16\linewidth}|p{0.25\linewidth}|p{0.49\linewidth}|}{
		...
		\hline
		Teman & \heb{תֵּימָן} (\emph{Têmān}) & Related to \heb{ימין}, “right hand,” hence geographically “south” when facing east. \\
		\hline
		Omar & \heb{אוֹמָר} (\emph{ʾÔmār}) & Usually compared with \heb{אמר}, “say/speak,” perhaps “speaker.” \\
		\hline
		Zepho & \heb{צְפוֹ} (\emph{Ṣəp̄ô}) & Perhaps from \heb{צפה}, “look/watch,” hence “watcher/gazing.” \\
		\hline
...
}
{
	...
	\Table{|p{0.16\linewidth}|p{0.25\linewidth}|p{0.49\linewidth}|}{
		...
		\textbf{Proper name} & \textbf{Hebrew} & \textbf{Possible Meaning} \\
		\hline
		Timna & \heb{תִּמְנָע} (\emph{Timnāʿ}) & Sometimes related to \heb{מנע}, “withhold/restrain,” perhaps “restraint.” \\
		\hline
		Eliphaz & \heb{אֱלִיפַז} & Perhaps “El is fine gold.” \\
		\hline
		Esau & \heb{עֵשָׂו} & See v.1. \\
...
}
{
	...
	\Table{|p{0.16\linewidth}|p{0.25\linewidth}|p{0.49\linewidth}|}{
		...
		\hline
		Nahath & \heb{נַחַת} (\emph{Naḥat}) & Identical with/related to \heb{נַחַת}, “rest, quiet, descent.” \\
		\hline
		Zerah & \heb{זֶרַח} (\emph{Zeraḥ}) & From \heb{זרח}, “rise/shine,” especially of the sun: “dawn/rising.” \\
		\hline
		Shammah & \heb{שַׁמָּה} (\emph{Šammāh}) & Could be associated with \heb{שׁם} “there/name” or \heb{שמם}-related forms, but no single derivation is secure for this name. \\
		\hline
...
}
{
	...
	\Table{|p{0.16\linewidth}|p{0.25\linewidth}|p{0.49\linewidth}|}{
		...
		\hline
		Horite & \heb{חֹרִי} (\emph{Ḥōrî}) & Older explanations connect with \heb{חור}, “hole/cave,” hence “cave-dweller,” but this is not secure. \\
		\hline
		Lotan & \heb{לוֹטָן} (\emph{Lôṭān}) & Possibly related to \heb{לוט}, “cover/wrap.” \\
		\hline
...
}
{
	...
	\Table{|p{0.16\linewidth}|p{0.25\linewidth}|p{0.49\linewidth}|}{
		...
		\hline
		Ezer & \heb{אֵצֶר} (\emph{ʾĒṣer}) & From \heb{אצר}, “store up,” hence “treasure/store.” \\
		\hline
...
}
{
	...
	\Table{|p{0.16\linewidth}|p{0.25\linewidth}|p{0.49\linewidth}|}{
		...
		\textbf{Proper name} & \textbf{Hebrew} & \textbf{Possible Meaning} \\
		\hline
		Lotan & \heb{לוֹטָן} & Perhaps from \heb{לוט}, “cover.” \\
		\hline
...
}
{
	...
	\Table{|p{0.16\linewidth}|p{0.25\linewidth}|p{0.49\linewidth}|}{
		...
		\hline
		Alvan & \heb{עַלְוָן} (\emph{ʿAlwān}) & Older analysis connects with \heb{עלה}, perhaps “lofty/high.” \\
		\hline
		Manahath & \heb{מָנַחַת} (\emph{Mānaḥat}) & Probably related to \heb{נוח/נחת}, “rest, resting place.” \\
		\hline
		...
		\hline
		Onam & \heb{אוֹנָם} (\emph{ʾÔnām}) & Probably related to \heb{אוֹן}, “strength/vigor,” hence “vigorous.” \\
		\hline
	}
	\endgroup
...
}
{
	...
	\Table{|p{0.16\linewidth}|p{0.25\linewidth}|p{0.49\linewidth}|}{
		...
		\hline
		Hemdan & \heb{חֶמְדָּן} (\emph{Ḥemdān}) & From \heb{חמד}, “desire/delight,” hence “pleasant/desirable.” \\
		\hline
		Eshban & \heb{אֶשְׁבָּן} (\emph{ʾEšbān}) & No secure Hebrew derivation. \\
		\hline
		Ithran & \heb{יִתְרָן} (\emph{Yitrān}) & From \heb{יתר}, “excess/abundance/excellence.” \\
		\hline
...
}
{
	...
	\Table{|p{0.16\linewidth}|p{0.25\linewidth}|p{0.49\linewidth}|}{
		...
		\hline
		Zaavan & \heb{זַעֲוָן} (\emph{Zaʿăwān}) & Possibly from \heb{זוע}, “tremble, be agitated,” hence “trembling.” \\
		\hline
...
}
{
	...
	\Table{|p{0.16\linewidth}|p{0.25\linewidth}|p{0.49\linewidth}|}{
		...
		\hline
		Uz & \heb{עוּץ} (\emph{ʿÛṣ}) & Sometimes related to \heb{עוץ}, “counsel/consult.” \\
		\hline
...
}
{
	...
	\Table{|p{0.16\linewidth}|p{0.25\linewidth}|p{0.49\linewidth}|}{
		...
		Edom & \heb{אֱדוֹם} & “Red.” \\
		\hline
		Israel & \heb{יִשְׂרָאֵל} (\emph{Yiśrāʾēl}) & Genesis 32 explains it through \heb{שרה}, “strive/contend,” + \heb{אל}: roughly “you have striven with God”; morphologically the name may also be understood with El as subject, “El strives/rules.” \\
		\hline
	}
	\endgroup
...
}
{
	...
	\Table{|p{0.16\linewidth}|p{0.25\linewidth}|p{0.49\linewidth}|}{
		...
		\textbf{Proper name} & \textbf{Hebrew} & \textbf{Possible Meaning} \\
		\hline
		Bela & \heb{בֶּלַע} (\emph{Belaʿ}) & Identical in consonants with \heb{בלע}, “swallow/devour”; thus “swallowing/devourer” is an obvious Hebrew association. \\
		\hline
		Beor & \heb{בְּעוֹר} (\emph{Bəʿôr}) & Traditionally connected with \heb{בער}, “burn,” yielding “burning” or “torch.” \\
		\hline
		Edom & \heb{אֱדוֹם} & “Red.” \\
		\hline
...
}
{
	...
	\Table{|p{0.16\linewidth}|p{0.25\linewidth}|p{0.49\linewidth}|}{
		...
		\hline
		Jobab & \heb{יוֹבָב} (\emph{Yôḇāḇ}) & Traditionally connected with \heb{יבב}, “cry/howl/wail,” hence approximately “howler.” \\
		\hline
		Zerah & \heb{זֶרַח} & “Rising/dawn.” \\
		\hline
		Bozrah & \heb{בָּצְרָה} (\emph{Boṣrāh}) & From \heb{בצר}, “fortify/enclose”; “fortification/fortress.” \\
		\hline
	}
	\endgroup
...
}
{
	...
	\Table{|p{0.16\linewidth}|p{0.25\linewidth}|p{0.49\linewidth}|}{
		...
		\hline
		Husham & \heb{חֻשָׁם} (\emph{Ḥušām}) & Usually connected with \heb{חושׁ}, “hurry/hasten,” giving something like “hasty one.” \\
		\hline
...
}
{
	...
	\Table{|p{0.16\linewidth}|p{0.25\linewidth}|p{0.49\linewidth}|}{
		...
		\hline
		Bedad & \heb{בְּדַד} (\emph{Bəḏaḏ}) & Probably associated with \heb{בדד}, “apart/alone.” \\
		\hline
		...
		\hline
		Avith & \heb{עֲוִית} (\emph{ʿĂwît}) & Older analysis connects with \heb{עוה}, “bend/twist,” perhaps “ruin/twisted”; BDB is cautious. \\
		\hline
	}
	\endgroup
...
}
{
	...
	\Table{|p{0.16\linewidth}|p{0.25\linewidth}|p{0.49\linewidth}|}{
		...
		\hline
		Samlah & \heb{שַׂמְלָה} (\emph{Śamlāh}) & Form resembles \heb{שִׂמְלָה/שַׂמְלָה}, “garment/cloak.” \\
		\hline
		Masrekah & \heb{מַשְׂרֵקָה} (\emph{Maśrēqāh}) & Often connected with \heb{שׂרק / שׂוֹרֵק}, “choice vine,” hence “vineyard/place of vines.” BDB itself is less certain about the underlying root. \\
		\hline
	}
	\endgroup
...
}
{
	...
	\Table{|p{0.16\linewidth}|p{0.25\linewidth}|p{0.49\linewidth}|}{
		...
		\hline
		Saul / Shaul & \heb{שָׁאוּל} (\emph{Šāʾûl}) & Qal passive participle of \heb{שאל}, “ask/request”: “asked for/requested.” \\
		\hline
		Rehoboth & \heb{רְחֹבוֹת} (\emph{Rəḥōḇôt}) & Plural of \heb{רְחֹב}, “broad place, plaza, street,” from \heb{רחב} “be broad.” \\
		\hline
	}
	\endgroup
...
}
{
	...
	\Table{|p{0.16\linewidth}|p{0.25\linewidth}|p{0.49\linewidth}|}{
		...
		\hline
		Baal-hanan & \heb{בַּעַל חָנָן} (\emph{Baʿal Ḥānān}) & “Baal is gracious / Baal has shown favor,” from \heb{בעל} + \heb{חנן}. \\
		\hline
...
}
{
	...
	\Table{|p{0.16\linewidth}|p{0.25\linewidth}|p{0.49\linewidth}|}{
		...
		\hline
		Hadar & \heb{הֲדַר} (\emph{Hăḏar}) & If this is the correct text, compare \heb{הדר}, “splendor, majesty, honor.” \\
		\hline
		...
		\hline
		Matred & \heb{מַטְרֵד} (\emph{Maṭrēḏ}) & Often connected with \heb{טרד}, “drive/drive away,” perhaps “driving/one who drives.” \\
		\hline
		Mezahab & \heb{מֵי זָהָב} (\emph{Mê Zāhāḇ}) & Read naturally as “waters of gold”: \heb{מֵי} “waters of” + \heb{זָהָב} “gold.” \\
		\hline
	}
	\endgroup
...
}
{
	...
	\Table{|p{0.16\linewidth}|p{0.25\linewidth}|p{0.49\linewidth}|}{
		...
		Esau & \heb{עֵשָׂו} & See v.1. \\
		\hline
		Timnah & \heb{תִּמְנָע} & Perhaps “restraint/withholding,” from \heb{מנע}. \\
		\hline
		Alvah & \heb{עַלְוָה} (\emph{ʿAlwāh}) & Older derivation associates it with \heb{עלה}/height, perhaps “loftiness.” BDB essentially records it as an Edomite proper name rather than confidently translating it. \\
		\hline
...
}
{
	...
	\Table{|p{0.16\linewidth}|p{0.25\linewidth}|p{0.49\linewidth}|}{
		...
		Teman & \heb{תֵּימָן} & “South/right-hand.” \\
		\hline
		Mibzar & \heb{מִבְצָר} (\emph{Miḇṣār}) & Identical in form with \heb{מִבְצָר}, “fortress, fortified place, stronghold,” from \heb{בצר}. \\
		\hline
	}
	\endgroup
...
}
{
	...
	\Table{|p{0.16\linewidth}|p{0.25\linewidth}|p{0.49\linewidth}|}{
		...
		\textbf{Proper name} & \textbf{Hebrew} & \textbf{Possible Meaning} \\
		\hline
		Magdiel & \heb{מַגְדִּיאֵל} (\emph{Magdîʾēl}) & Usually understood with \heb{גדל/מגד} + \heb{אל}, something like “El is greatness,” “excellence of El,” or “El makes great.” \\
		\hline
		Iram & \heb{עִירָם} (\emph{ʿÎrām}) & Sometimes associated with \heb{עִיר}, “city,” but BDB gives no secure derivation. \\
		\hline
		Edom & \heb{אֱדוֹם} & “Red.” \\
		\hline
