...
%	}
	...
	\Table{|p{0.16\linewidth}|p{0.25\linewidth}|p{0.49\linewidth}|}{
		...
		\hline
		Adah & \heb{עָדָה (\emph{ʿĀdāh})} & Usually “ornament/adornment,” from עדה in an adornment-related sense. BDB also notes an Arabic comparison possibly suggesting “morning.” \\
		\hline
		Elon & \heb{אֵילוֹן (\emph{ʾÊlôn})} & “Terebinth/oak” or “oak-grove,” related to אַיִל/אֵלָה tree vocabulary. \\
		\hline
		Hittite & \heb{חִתִּי (\emph{Ḥittî})} & No persuasive Hebrew lexical etymology. \\
		\hline
		Aholibamah & \heb{אָהֳלִיבָמָה (\emph{ʾĀholîbāmāh})} & “Tent of the high place”: אֹהֶל “tent” + בָּמָה “high place/elevation.” \\
		\hline
		Anah & \heb{עֲנָה (\emph{ʿĂnāh})} & Could be compared with ענה, “answer/respond,” but the proper-name derivation is not certain. \\
		\hline
		Zibeon & \heb{צִבְעוֹן (\emph{Ṣibʿôn})} & Often connected with צבע, “color/dye,” hence “colored/variegated”. \\
		\hline
		Hivite & \heb{חִוִּי (\emph{Ḥiwwî})} & No secure Hebrew etymology; proposals involving חוה or animal vocabulary are speculative. \\
	}
	\endgroup
...
}
{
	...
	\Table{|p{0.16\linewidth}|p{0.25\linewidth}|p{0.49\linewidth}|}{
		...
		\hline
		Basemath & \heb{בָּשְׂמַת} (\emph{Bāśəmat}) & Related to בֹּשֶׂם, “balsam, spice, perfume”; thus “fragrance/perfume.” \\
		\hline
		Ishmael & \heb{יִשְׁמָעֵאל} (\emph{Yišmāʿēl}) & From שמע “hear” + אל “El/God”: “El hears.” \\
		\hline
		Nebaioth & \heb{נְבָיוֹת} (\emph{Nəḇāyôt}) & No secure Biblical Hebrew etymology. A connection with נוב “flourish/bear fruit” is possible but weak. \\
	}
	\endgroup
...
}
{
	...
	\Table{|p{0.16\linewidth}|p{0.25\linewidth}|p{0.49\linewidth}|}{
		...
		\hline
		Eliphaz & \heb{אֱלִיפַז} (\emph{ʾĔlîpaz}) & Usually parsed אֵל + פָּז, approximately “El/God is fine gold.” BDB explicitly puts a question mark on this explanation. \\
		\hline
		Basemath & \heb{בָּשְׂמַת} & “Fragrance/perfume.” \\
		\hline
		Reuel & \heb{רְעוּאֵל} (\emph{Rəʿûʾēl}) & Usually רע/רעה + אל, “friend/companion of El” or “El is a friend.” \\
	}
	\endgroup
...
}
{
	...
	\Table{|p{0.16\linewidth}|p{0.25\linewidth}|p{0.49\linewidth}|}{
		...
		\hline
		Jalam & \heb{יַעְלָם} (\emph{Yaʿlām}) & Sometimes related to עלם, “hide,” yielding “hidden,” but BDB's comparative material points toward a wider semantic field involving young adulthood/strength. \\
		\hline
		Korah & \heb{קֹרַח} (\emph{Qōraḥ}) & Perhaps from קרח, “ice/frost.” \\
	}
	\endgroup
