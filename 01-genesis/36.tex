...
}
{
	\Table{|p{0.16\linewidth}|p{0.25\linewidth}|p{0.49\linewidth}|}{
		...
		\hline
		Seir
			& \heb{שֵׂעִיר} (\emph{Śēʿîr})
			& Closely related to \heb{שֵׂעִיר/שֵׂעָר}, “hairy, shaggy /
			 hair.” \\
		\hline
		Edom
			& \heb{אֱדוֹם}
...
}
{
	\Table{|p{0.16\linewidth}|p{0.25\linewidth}|p{0.49\linewidth}|}{
		...
		Ithran
			...
			& From \heb{יתר}, “excess/abundance/excellence.” \\
		\hline
		Cheran
...
}
{
	\Table{|p{0.16\linewidth}|p{0.25\linewidth}|p{0.49\linewidth}|}{
		...
		Bilhan
			...
			& BDB regards the derivation as uncertain; older proposals connect it with
	...
	\Table{|p{0.16\linewidth}|p{0.25\linewidth}|p{0.49\linewidth}|}{
		...
		Alvah
			...
			& Older derivation associates it with \heb{עלה}/height, perhaps
			 “loftiness.” BDB essentially records it as an Edomite proper name rather
			 than confidently translating it. \\
		\hline
		Jetheth
			& \heb{יְתֵת} (\emph{Yəṯêṯ})
			& Derivation explicitly uncertain in the major lexica; older glosses such as
			 “nail” are not secure. \\
		\hline
	}
...
}
{
	\Table{|p{0.16\linewidth}|p{0.25\linewidth}|p{0.49\linewidth}|}{
		...
		Esau
			& \heb{עֵשָׂו}
			& Possible “made/formed/rough” association; historically uncertain. \\
		\hline
	}
