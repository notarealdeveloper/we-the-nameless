	...
	\begin{tikzpicture}
		...
		\begin{scope}[on background layer]
			...
			\path
				...
				{
					\flipvertical{\JacobBlessingHand}
				};
...
{
	\aB{So Joseph's like ``}\aA{Not good dad.}\aB{''}
	...
	\aA{
		\egypt{
			𓋴𓁣\raisebox{1.2em}{\hspace{-0.65em}{𓏏}}\hspace{0.5em}%
...
{
	\aB{
		He blesses them by talking about how he'll bless them.
	
		Ephraim's the favorite.
	}
}
...
{
	\aB{So Israel's like ``}\aC{I'm dying, son.}\aB{''}
}
...
{
	\aB{Then he makes a pun about Shechem.}%
	\fC{
	...
	\aB{And switches genres.}

	\aB{Time for the song...}
}
