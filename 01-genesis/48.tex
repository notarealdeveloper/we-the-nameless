...
{
	Ok so Joseph brings his kids to grandpa, then he bows, nose to the ground.

	\aB{
		Fortunately we're in Egypt, where the local writing system
		allows us to express this situation with surprising clarity.
	}
