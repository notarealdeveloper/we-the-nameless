...
{
	Joseph gives him the ``It's not me it's God, but I
...
}
{
	...
	\aC{The verb here means “to kiss.” We don't know why he's saying that.}%
...
}
{
	...
	\aA{\egypt{𓊗𓈖𓏏 𓊪𓂝𓋹}} \aC{of} %

	\aB{\egypt{𓃒𓃽𓃓𓃕𓃖𓃜𓃔}} \aA{and} %

	\aC{\egypt{𓏏𓏒𓏙𓊰𓌾𓏘𓉅}} \aB{who} %

	\aA{\egypt{𓁹𓁀}} \aC{and}
	\aB{\egypt{𓂺}} \aA{in a \egypt{𓃒} of}
	\aC{\egypt{𓂸𓊝}}

	\aA{\egypt{𓅭}}\aB{\egypt{𓇳}}%
	\fC{
		Lit. ``Lord Joseph of the seven cows and seven breads [sic],
		who sees dreams, and came in a time of hardship.'' The ordering
		of signs in the original is roughly comparable with the order 
		in the translation, with the exception of the honorific
		term \egypt{𓅭𓇳}, meaning Lord, and pronounced /zeːra/,
		suspiciously similar to that word for the ``seed'' 
		(Heb. \heb{זרע}) that YHWH (aka, the \textsc{Lord}) is
...
}
{
	...
	\eR{Joseph explores the country again.}
}
...
{
	They had a fistful of bread for the first seven cows.
}
...
{
	He stores it up in savings.

	He puts it in the cities.
}
...
{
	There was infinity number of bread.
}
...
}
{
	\eE{
		...
		came—to whom Asenath, daughter of Potiphera, priest of
		On, gave birth for him.
	}
}
{
	Joseph and his two kids come before the famine does.
}
...
{
	He does the Rachel/Leah pun thing.
	
	Manasseh means... I forget.
}
...
{
	He names the second son fruitful.
}
...
{
	Nevermind everyone's starving.

	The king is basically retired at this point.
	
	People ask him for stuff and he's like ``I dunno, ask Joe.''
}
...
{
	Ok everyone on earth is starving.

	So Joseph opens up the food reserves and sells them at a profit
	to the citizens of the country he's somehow in charge of.\fB{
		This is the actual bible.
	}
...
{
	Then he sells the rest at a profit to all the nations.\fB{
		Lit. goyim.
	}
}
