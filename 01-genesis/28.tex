...
{
	\aA{
		And may God of the Mountain \aB{(or God of Breasts, we're not sure, but it's possible that Shaddai means something about fertility)} give you lots of fertility \aB{(what a coincidence.)}
	}
}
...
}
{
	...
	\aA{
		That's in Paddan Aram.
	}

	\aB{White house is in Paddan Aram, don't forget.}
}
...
%	}
	...
	\aA{
		Now he sees that Jacob got the blessing because of the whole Hittite Wives thing.
	}
}
...
{
	\aA{
		So Esau sees that his dad doesn't like Canaanite girls.
	}
}
...
{
	\aA{
		Now Esau goes to his uncle and marries his cousin as a third wife, which he hopes his dad will approve of.
	}
}
...
}
{
	...
	\aA{
		Sees angels of God going all up and down it.
	}
}
