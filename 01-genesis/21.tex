...
{
	\eJ{
		And YHWH took account of Sarah as He had said, and YHWH
...
}
{
	...
	Because \eRed{God} got her pregnant.\eRed{\footnote{Documentary Note: This line is often attributed to J. This is strange, given that it contains the word ``God'' spoken by the narrator. This is otherwise unknown in the J source, as J h\redacted{er}self never calls YHWH ``God,'' though characters in J sometimes do (the first example being the snake in Genesis 3.) Also the use of the phrase ``appointed time'' is characteristic of P, though not exclusively.}}
}
...
}
{
	...
	\item E's universe is one in which God exists and his name's YHWH but it's not illegal to have fun, and in which writing a bible doesn't rule out the occasional pun.
