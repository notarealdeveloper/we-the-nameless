...
}
{
	...
	Because \eRed{God} got her pregnant.\eRed{\footnote{Documentary Note: This line is often attributed to J. This is strange, given that it contains the word ``God'' spoken by the narrator. This is otherwise unknown in the J source, as J herself never calls YHWH ``God,'' though characters in J sometimes do (the first example being the snake in Genesis 3.) Also the use of the phrase ``appointed time'' is characteristic of P.
}
