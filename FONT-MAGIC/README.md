...
FONT-MAGIC turns a photographed, scanned, or drawn early-alphabet chart into inspectable SVG sources plus SFD, OTF, TTF, proof, and provenance report. Its governing rule is source fidelity: it keeps wobble, asymmetry, variable stroke weight, damage, variants, and uncertainty rather than modernizing them.
