...
{
	\eJ{
		21 And the Canaanite, the king of Arad, who lived in the\\
...
}
{
	\eJ{
		...
		was getting short on the way. {[image]}\\
	}
}
{
%	\footnote{
...
%		freedom owing to “shortage of spirit” ([image]—Exod 6:9). Freedom has
...
}
{
	\eJ{
		...
		soul is disgusted with the cursed bread.” {[image]}\\
	}
}
{
%	\footnote{
...
}
{
	\eJ{
		...
		And Moses prayed on behalf of the people. {[image]}\\
	}
}
{
}
...
}
{
	\eE{
		...
		between Moab and the Amorite. {[image]}\\
	}
}
{
}
...
\Verse{14}
{
	\hE{עַל כֵּן יֵאָמַר בְּסֵפֶר מִלְחֲמֹת יְהֹוָה אֶת וָהֵב בְּסוּפָה וְאֶת הַנְּחָלִים אַרְנוֹן׃}
}
{
	\eE{
		On account of this it is said in the Scroll of the Wars of\\
		YHWH: Waheb in Suphah and the wadis of Arnon, {[image]}\\
	}
}
{
%	\footnote{
...
}
{
	\eE{
		...
		of Ar, and pressed to Moab’s border. {[image]}\\
	}
}
{
}
...
}
{
	\eE{
		...
		go by the king’s road until we pass your border.” {[image]}\\
	}
}
{
}
...
}
{
	\eE{
		...
		Built and founded is Sihon’s city. {[image]}\\
	}
}
{
}
...
}
{
	\eE{
		...
		the king of the Amorite, Sihon. {[image]}\\
	}
}
{
}
...
}
{
	\eE{
		...
		devastated up to Nophah which reaches to Medeba. {[image]}\\
	}
}
{
}
...
{
	\eE{And Israel lived in the Amorite’s land. [image]}
}
{
}
...
}
{
	\eE{
		...
		the Amorite, who lived in Heshbon.” {[image]}\\
	}
}
{
}
