...
{
	\eP{
		to form conceptions to make in goֹld and in silver and in
		bronze
	}
}
{
...
{
	\eP{
		the Teֶnt oְf Meֵetiִng and the Ark of the Testimony and the
...
}
{
	\eP{
		...
		all its equipment and the iִnceֶnse altar
	}
}
{
}
...
{
	\eP{
		and the fabric clothes and the hoֹlyִ clothes for Aַaroֹn, the
...
{
	\eP{
		and the aְnoֹiִntiִng oil and the iִnceֶnse of fragrances for
		the Hoֹlyִ. According to everything that I’ve commanded you,
		they shall do.”
	}
}
{
...
{
	\eP{
		And you shall observe the Sabbath, because it is a hoֹlyִ thing to
...
}
{
	\eP{
		...
		Sabbath, a ceasing, a hoֹlyִ thing to YHWH. Anyone who does
