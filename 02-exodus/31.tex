...
{
	\eP{
		to form conceptions to make in goֹlְd and in silver and in
		bronze
	}
}
{
...
{
	\eP{
		the Teֶnְt of Meֵeִtiַnְg and the Ark of the Testimony and the
...
}
{
	\eP{
		...
		all its equipment and the iִnְceֶnְseֵ altar
	}
}
{
}
...
{
	\eP{
		and the fabric clothes and the hoֹlֵy clothes for Aaָrֲoֹnְ, the
...
{
	\eP{
		and the aֲnoֹiִnְtiֵng oil and the iִnְceֶnְseֵ of fragrances for
		the Hoֹlֵy. According to everything that I’ve commanded you,
		they shall do.”
	}
}
{
...
{
	\eP{
		And you shall observe the Sabbath, because it is a hoֹlֵy thing to
...
}
{
	\eP{
		...
		Sabbath, a ceasing, a hoֹlֵy thing to YHWH. Anyone who does
