...
}
{
	...
	\aC{
		Heb. \paleo{מְשִׁה} (\textsl{msh}) because \paleo{מְשִׁיתִֽהוּ} (\textsl{mshitho}) from the water.
	}
	\end{quote}
...
}
{
	...
	\aC{
		...
		goes between the bricks, and%
	}%
	\aB{however}
	\eR{they could do so}
	\aC{they did so—with all the work in the
	...
	And now for the next exciting installment of: \eP{P!}
}
...
{
	Ok so the \eP{Elohim} character hears the complaining,
	and it reminds him about the main characters from the
	bible and how he promised to go down with them on the
	quick family getaway to Egypt and also promised to
	bring them back home after back in Genesis 46:4,
	but apparently he forgot about all that for
	like four hundred or so years.
...
{
	And he sees them.\fB{Lit. Oi! \paleo{רע} \heb{אלהים}.}

	His children of\fB{Lit. Son of---} \eR{Israel}.

	And God\fB{Lit. El: Oh, \textsc{I'm}---} knew.\fB{Lit. El: Oh \eRJE{\heb{ידע}}!---}
}
