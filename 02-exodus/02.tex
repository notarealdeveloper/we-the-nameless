...
}
{
	...
	no \textsl{men} \aB{who Drew} \aC{no the shephers} and Drew
	\aB{drove them away} because first before drew
	they were chasing us away from the \aB{well but well Drew}
	\aB{chased them away} so they couldn't chase us away anymore
	\aC{and but so} Drew drew water \aC{for us too}
	no us seven \aC{and Drew also drew} \aB{water}
	\aC{you talking about} \aB{him} and \aB{t}he
	flock a\aB{n}\aC{d} us too.\fC{The text is a bit much here.}
