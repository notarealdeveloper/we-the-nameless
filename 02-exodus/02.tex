...
{
	She's already pre--- \aB{It's a boy!}\fC{The text is a bit rushed here.}
...
}
{
	...
	\aC{with all the work in the
		...
		Now, the next exciting installment of: P!
	}

	\aB{in\eR{ their }stead\eR{fast faith they held fast} of that \eR{land}, back to P.}
}
