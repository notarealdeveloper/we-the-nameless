...
}
{
	...
	Ok so \aB{Drew drew} \aC{no the men}
	and this man \aB{an Egyptian}\fB{Drew's Egyptian.}
	\aC{drove away all the men} because first there
	were men chasing us away \aB{and Drew chased them
	away} and Drew drew water \aC{for us}
	seven and also drew \aB{water} \aC{you talking about}
	\aB{for the} flock and us too.\fC{The text is a bit much here.}

	There was a lot going on in the explanation but
	he was used to it.
}
...
}
{
	...
	\aB{Now I imagine all the girls sort of pause and double take}
