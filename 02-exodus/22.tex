...
{
%	\footnote{
%		no blood for him. Meaning: there is no bloodguilt for
%		killing him. The
%		person who killed the thief who was in the act of
...
{
%	\footnote{
%		22.2. If the sun has risen on him there is blood for
%		him. If the
%		theft was in the daytime—which is less frightening and
%		when escape,
%		help, and witnesses are more possible—then one is
%		legally
%		responsible if one kills the thief.
%
%		Footnote 22:2. He shall pay. If the thief is caught, not
%		killed, he
%		must pay for his theft.
%
%		Footnote 22:2. If he does not have it, then he shall be
%		sold for his
%		theft. If the thief does not have the money to pay for
%		his theft,
...
{
%	\footnote{
%		brought near to God: that he has not put out his hand.
%		The wording
%		(starting with ’im) plus the notice of being brought
%		“near to God”
%		indicate that he is to take an oath that he has not
%		taken the missing
%		property for which he was responsible. The wording
%		occurs again in 22:10
...
{
%	\footnote{
%		implicate. The verb here is plural. Some therefore take
%		its subject,
%		’lhîm, not to refer to God here and in the preceding
%		verse. (See Rashi
%		and Ibn Ezra.) Rather, it is understood to refer to the
%		judges before
...
{
%	\footnote{
%		he shall not pay. The person who was watching the animal
%		does not pay
...
{
%	\footnote{
%		witness. Rashi understands this to mean that he brings
%		witnesses. Ibn
%		Ezra suggests that it means that he brings a portion of
%		the torn animal
%		as evidence. The latter is the understanding of most
%		contemporary
%		translators.
%	}
}
...
{
%	\footnote{
%		a witch. Why does the text condemn only women and not
%		male sorcerers?
%		Males are identified as practicing magic as well, as in
%		the case of the
%		Egyptian magicians (Exod 7:11). The feminine form of
%		this word occurs
%		only here out of the entire Tanak. And the Septuagint
%		has the masculine
%		plural (which is used to include both men and women)
%		here instead of the
%		Masoretic Text’s feminine singular. This suggests that
%		the original text
%		forbids the practice of magic by either men or women
%		(sorcerers or
%		witches). Note also: the text does not deny that magic
%		works. (On the
%		contrary, the Egyptian magicians can turn staffs into
%		snakes.) It
...
{
%	\footnote{
%		completely destroyed. Hebrew erem refers to the rule of
%		destroying an
%		individual or community along with all his family,
%		animals, and
%		possessions and thus dedicating them to the deity rather
%		than profiting
...
{
%	\footnote{
%		chieftain. Hebrew nî’. Elsewhere in the Torah the text
%		refers to the
%		chieftain of a tribe (Num 2:3–29) or of a priestly
%		family (Num 3:24–35)
%		or of a city (Gen 34:2). Here it may allude to a king of
%		Israel, “a
%		chieftain among your people” (as in 1 Kings 11:34; Ezek
%		34:24), or it
...
{
%	\footnote{
%		fulfillment and your flowing. Everyone is unsure of what
%		this means.
%	}
}
...
{
%	\footnote{
%		meat that is torn. This refers to the meat of an animal
%		that was killed
%		by another animal rather than having been killed in the
%		sacred manner
%		prescribed by the law. The word for “torn” (Hebrew trph)
%		later came to
