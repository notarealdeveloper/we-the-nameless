...
{
%	\footnote{
%		and the heart of Pharaoh … was changed. The word that
%		was used for the
%		stick’s changing into a snake and the water’s changing
%		into blood and
%		the changing of the wind that carried away the locusts
%		is now used to
%		describe Pharaoh’s change of heart. Those past cases,
%		plus the passive
%		(Niphal) form of the verb here, indicate that it is not
%		Pharaoh himself
...
\Verse{9}
{
	\hJ{וַיִּרְדְּפוּ מִצְרַיִם אַחֲרֵיהֶם}
	\hP{וַיַּשִּׂיגוּ אוֹתָם חֹנִים עַל הַיָּם כּל סוּס רֶכֶב פַּרְעֹה וּפָרָשָׁיו וְחֵילוֹ עַל פִּי הַחִירֹת לִפְנֵי בַּעַל צְפֹן׃}
}
{
	\eJ{And Egypt pursued them,}
	\eP{and they caught up to them,
...
\Verse{10}
{
	\hP{וּפַרְעֹה הִקְרִיב}
	\hJ{וַיִּשְׂאוּ בְנֵי יִשְׂרָאֵל אֶת עֵינֵיהֶם וְהִנֵּה מִצְרַיִם נֹסֵעַ אַחֲרֵיהֶם וַיִּירְאוּ מְאֹד}
	\hP{וַיִּצְעֲקוּ בְנֵי יִשְׂרָאֵל אֶל יְהֹוָה׃}
}
{
	\eP{And Pharaoh came close!}
	\eJ{And the children of Israel raised
		their eyes, and here was Egypt coming after them, and they
		were very afraid.}
	\eP{And the children of Israel cried out to YHWH.}
}
{
}
...
\Verse{11}
{
	\hE{וַיֹּאמְרוּ אֶל מֹשֶׁה הֲמִבְּלִי אֵין קְבָרִים בְּמִצְרַיִם לְקַחְתָּנוּ לָמוּת בַּמִּדְבָּר מַה זֹּאת עָשִׂיתָ לָּנוּ לְהוֹצִיאָנוּ מִמִּצְרָיִם׃}
}
{
	\eE{
...
{
%	\footnote{
%		an absence—none!—of graves. Their words are redundant.
%		The prophet
%		Elijah uses the same expression: “Is it because of an
%		absence—none!—of a
%		God in Israel that you go to inquire of Baal?!” (2 Kings
%		1:3,6,16). The
%		redundancy dramatizes the question in each case, as if
%		to say, “Was it
%		because of a complete and utter lack …”—the way people
%		speak when
%		accusing someone of doing something completely
%		senseless. Footnote
%		14:11. you’ve done to us. As with Joseph, people focus
%		on the human,
%		Moses, as if he and not God were the one who brought
%		this about.
%	}
}
...
\Verse{12}
{
	\hE{הֲלֹא זֶה הַדָּבָר אֲשֶׁר דִּבַּרְנוּ אֵלֶיךָ בְמִצְרַיִם לֵאמֹר חֲדַל מִמֶּנּוּ וְנַעַבְדָה אֶת מִצְרָיִם כִּי טוֹב לָנוּ עֲבֹד אֶת מִצְרַיִם מִמֻּתֵנוּ בַּמִּדְבָּר׃}
}
{
	\eE{
...
\Verse{19}
{
	...
	\hJ{וַיִּסַּע עַמּוּד הֶעָנָן מִפְּנֵיהֶם וַיַּעֲמֹד מֵאַחֲרֵיהֶם׃}
}
{
	\eE{And the angel of God who was going in front of the camp of
		Israel moved and went behind them,}
	\eJ{and the column of cloud
...
\Verse{20}
{
	\hE{וַיָּבֹא בֵּין מַחֲנֵה מִצְרַיִם וּבֵין מַחֲנֵה יִשְׂרָאֵל}
	\hJ{וַיְהִי הֶעָנָן וְהַחֹשֶׁךְ וַיָּאֶר אֶת הַלָּיְלָה וְלֹא קָרַב זֶה אֶל זֶה כּל הַלָּיְלָה׃}
}
{
	\eE{And it came between the camp of Egypt and the camp of
		Israel.}
	\eJ{And there was the cloud and darkness [for the
...
\Verse{21}
{
	\hP{וַיֵּט מֹשֶׁה אֶת יָדוֹ עַל הַיָּם}
	\hJ{וַיּוֹלֶךְ יְהֹוָה אֶת הַיָּם בְּרוּחַ קָדִים עַזָּה כּל הַלַּיְלָה וַיָּשֶׂם אֶת הַיָּם לֶחָרָבָה}
	\hP{וַיִּבָּקְעוּ הַמָּיִם׃}
}
{
	\eP{And Moses reached his hand out over the sea,}
	\eJ{and YHWH
		drove back the sea with a strong east wind all night and
		turned the sea into dry ground,}
	\eP{and the water was split.}
}
{
	%\fC{
	%	REF: In the J Red Sea story, the Hebrew uses the same
	%	term for dry ground (ḥārābâ) that is used in the J flood
	%	story (Gen 7:22). Meanwhile, in the P Red Sea story, the
	%	Hebrew uses the same term for dry ground (yabbāšâ) that
	%	is used in the P flood (and creation) story (Gen 1:9,10;
	%	8:14).
	%}
	\fC{%
		Each source repeats its own word for dry ground across
		the sea and flood stories: J uses
		ḥārābâ (Gen 7:22), while P uses yabbāšâ, also found in
		its creation account (Gen 1:9–10;
		8:14).%
	}
}
...
\Verse{25}
{
	\hE{וַיָּסַר אֵת אֹפַן מַרְכְּבֹתָיו וַיְנַהֲגֵהוּ בִּכְבֵדֻת}
	\hJ{וַיֹּאמֶר מִצְרַיִם אָנוּסָה מִפְּנֵי יִשְׂרָאֵל כִּי יְהֹוָה נִלְחָם לָהֶם בְּמִצְרָיִם׃}
}
{
	\eE{and He turned its chariots’ wheel so that it drove it with
		heaviness.}
	\eJ{And Egypt said, “Let me flee from Israel,
		because YHWH is fighting for them against Egypt!”}
}
{
%	\footnote{
%		heaviness. The recurrence of the word “heavy” to
%		describe yet another
%		event conveys that the plagues section of the story and
%		the Red Sea
%		section are united. The event at the sea is not just one
%		more episode;
...
{
	\hP{וַיֵּט מֹשֶׁה אֶת יָדוֹ עַל הַיָּם}
	\hJ{וַיָּשׁב הַיָּם לִפְנוֹת בֹּקֶר לְאֵיתָנוֹ וּמִצְרַיִם נָסִים לִקְרָאתוֹ וַיְנַעֵר יְהֹוָה אֶת מִצְרַיִם בְּתוֹךְ הַיָּם׃}
}
{
	\eP{And Moses reached his hand out over the sea,}
	\eJ{and the sea
...
\Verse{30}
{
	\hJ{וַיּוֹשַׁע יְהֹוָה בַּיּוֹם הַהוּא אֶת יִשְׂרָאֵל מִיַּד מִצְרָיִם וַיַּרְא יִשְׂרָאֵל אֶת מִצְרַיִם מֵת עַל שְׂפַת הַיָּם׃}
}
{
	\eJ{
...
\Verse{31}
{
	\hJ{וַיַּרְא יִשְׂרָאֵל אֶת הַיָּד הַגְּדֹלָה אֲשֶׁר עָשָׂה יְהֹוָה בְּמִצְרַיִם וַיִּירְאוּ הָעָם אֶת יְהֹוָה וַיַּאֲמִינוּ בַּיהֹוָה וּבְמֹשֶׁה עַבְדּוֹ׃}
}
{
	\eJ{
...
{
%	\footnote{
%		they trusted. This word is also translated often as
%		“believed” (Hebrew
%		wayya’mînû). It does not have the meaning here that it
%		has in later
%		religious concepts. That is, it does not function in the
%		sense of
%		believing that a God exists. This notion of belief in
%		does not occur in
%		Biblical Hebrew (nor in other ancient Near Eastern
%		languages). In pagan
%		religion the gods, being observable forces in nature
%		(e.g., the sun, the
%		sky, the storm wind), are not a matter of belief but of
%		knowledge. So in
%		the conception of YHWH in Exodus, God becomes known;
%		God’s existence and
%		power are a matter of knowledge, not belief. When one
%		has seen ten
%		plagues and a sea split and has a column of cloud and
%		fire visible at
%		all times, one does not ask, “Do you believe in God?” As
%		the term is
%		used in the Hebrew Bible, it means not belief in, but
%		belief that; that
%		is, it means that if YHWH says He will do something one
%		can trust that
%		He will do it.
%	}
}
