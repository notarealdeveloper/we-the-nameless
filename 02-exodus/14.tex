...
{
	\fC{REF: In the J Red Sea story, the Hebrew uses the same term for dry ground (ḥārābâ) that is used in the J flood story (Gen 7:22). Meanwhile, in the P Red Sea story, the Hebrew uses the same term for dry ground (yabbāšâ) that is used in the P flood (and creation) story (Gen 1:9,10; 8:14).}
}
