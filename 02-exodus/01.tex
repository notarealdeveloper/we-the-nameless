...
}
{
	Seventy people came out of Jacob's \heb{ירך}\fB{
		The place where babies come from in Genesis 46:26 and Judges 8:30,
		and the thing that old dying men have the youngsters grab with their
		hand and make an oath on, in Genesis 24:2 and Genesis 47:29.
...
}
{
	...
	you and likes you, and then some other a\eR{dministrator or a}ss%
	\eR{ociate thereof takes over the w}hole \eR{company, he just} takes over
	the whole company and then all the status you'd built up before is sort
	of floating out in an empty void of nostalgia and confidence about how
	you used to be useful but none of that matters at work anymore so eventually
	you realize it's time to get the hell out of there and go somewhere else,
...
{
	He's like we better take care of these people now or
	they might become our enemies.
...
}
{
	...
	They're named Young and Beautiful.\fB{Lit. YNG and BOtfl in the original.}
...
}
{
	...
	out of the ladies, look down at the, you know, the two stones.%
	%\fC{
