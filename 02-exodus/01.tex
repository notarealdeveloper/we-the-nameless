...
}
{
	...
	He goes to these two cute young OBGYN	s from team Jacob.

	They're named Young and Beautiful.
...
}
{
	...
	The two stones that tell you if it's a boy or not.
	
	And if it's a boy, kill him.
...
{
	So the king comes back and he's like ``Perhaps I wasn't clear, ladies.''
}
...
{
	So Young and Beautiful are like,
