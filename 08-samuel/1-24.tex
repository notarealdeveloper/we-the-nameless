...
}
{
	...
	\aB{
		\begin{enumerate}
		\item Let us take it as given that I'm a very unthreatening animal metaphor.
		\item Now, in the category \textsc{Beh} of behaviors, the silliness of a
				 behavior is preserved under maps between a metaphor's source object
				 or domain, and its target object or codomain.
		\item Therefore, the diagram commutes, and the theorem follows.
		\end{enumerate}
	}
