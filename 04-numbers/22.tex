...
{
	\hE{וַיֹּאמֶר מוֹאָב}
	\hR{אֶל זִקְנֵי מִדְיָן}
	\hE{עַתָּה יְלַחֲכוּ הַקָּהָל אֶת כּל סְבִיבֹתֵינוּ כִּלְחֹךְ הַשּׁוֹר אֵת יֶרֶק הַשָּׂדֶה וּבָלָק בֶּן צִפּוֹר מֶלֶךְ לְמוֹאָב בָּעֵת הַהִוא׃}
}
{
	\eE{And Moab said}
	\eR{to the elders of Midian,}
	\eE{
		“Now the community will lick up all of our surroundings the way an ox licks
		up the plants of a field!” And Balak, son of Zippor, was king of Moab at
		that time.
	}
}
{
...
\Verse{5}
{
	\hJ{וַיִּשְׁלַח מַלְאָכִים}
	\hE{אֶל בִּלְעָם בֶּן בְּעֹר פְּתוֹרָה אֲשֶׁר עַל הַנָּהָר אֶרֶץ בְּנֵי עַמּוֹ לִקְרֹא לוֹ לֵאמֹר הִנֵּה עַם יָצָא מִמִּצְרַיִם הִנֵּה כִסָּה אֶת עֵין הָאָרֶץ וְהוּא יֹשֵׁב מִמֻּלִי׃}
}
{
	\eJ{And he sent messengers}
	\eE{
		to Balaam, son of Beor, at Pethor, which is on the river—the land of the
		children of his people—to call him, saying, “Here, a people has come out
		from Egypt. Here, it has covered the eye of the land. And it’s sitting
		across from me!
	}
}
{
...
\Verse{15}
{
	\hJ{וַיֹּסֶף עוֹד בָּלָק}
	\hE{שְׁלֹחַ שָׂרִים רַבִּים וְנִכְבָּדִים מֵאֵלֶּה׃}
}
{
	\eJ{And Balak went on again}
	\eE{
		to send more numerous and prestigious chiefs than these.
	}
}
{
}
...
\Verse{26}
{
	\hE{וַיּוֹסֶף מַלְאַךְ יְהֹוָה עֲבוֹר וַיַּעֲמֹד בְּמָקוֹם צָר אֲשֶׁר אֵין דֶּרֶךְ}
	\hJ{לִנְטוֹת יָמִין וּשְׂמֹאול׃}
}
{
	\eE{
		And the angel continued passing on and stood in a narrow
		place where there was no way
	}
	\eJ{to turn right or left.}
}
{
}
...
{
	He's apparently not surprised that the ass is talking.%
	\fC{
		REF: Balaam said to the ass. As usual, the text does not provide details
