...
\DeclareSourceProfile{E}
    ...
    {\HebrewDavid} {\addfontfeatures{Scale=1.42}\color{Ecolor}\bfseries}

\DeclareSourceProfile{P}
    {\EnglishFont}   {\color{Pcolor}\bfseries}
    {\HebrewEzraRaw} {\addfontfeatures{Scale=1.23}\color{Pcolor}\mdseries}

\DeclareSourceProfile{DtrOne}
    {\EnglishFont}   {\color{Dtr1color}\mdseries}
    {\HebrewEzraRaw} {\addfontfeatures{Scale=1.23}\color{Dtr1color}\mdseries}

\DeclareSourceProfile{DtrTwo}
    {\EnglishFont}   {\color{Dtr2color}\bfseries}
    {\HebrewEzraRaw} {\addfontfeatures{Scale=1.23}\color{Dtr2color}\bfseries}

\DeclareSourceProfile{Dtn}
    {\EnglishFont} {\color{Dtncolor}\itshape}
    {\HebrewDavid} {\addfontfeatures{Scale=1.42}\color{Dtncolor}\itshape}

\DeclareSourceProfile{R}
    {\EnglishFont}   {\color{Rcolor}\mdseries}
    %{\HebrewEzraRaw} {\color{Rcolor}\mdseries}
    {\AramaicFont} {\color{Rcolor}\mdseries}
...
\DeclareSourceProfile{Records}
    ...
    {\HebrewEzra}  {\color{RecordsColor}\itshape}

\DeclareSourceProfile{Other}
    {\EnglishFont}  {\color{OtherColor}\itshape}
    {\HebrewOther}  {\color{OtherColor}\itshape}
...
\NewDocumentCommand{\aP}{ O{l} +m }{\as{\aPEnglish}[#1]{#2}}
...
\NewDocumentCommand{\defineword}{m m o}{%
    ...
    \expandafter\gdef
    \csname\expandafter\@gobble\string#1Init\endcsname
    {%
        \IfNoValueTF{#3}
            {\bookautoInit{#2}}
            {#3}%
