...
\colorlet{RecordsColor}{Rcolor}
\colorlet{Recordsbgcolor}{RecordsColor!14!white}
%\definecolor{RecordsColor}{RGB}{0,70,170}
%\definecolor{Recordsbgcolor}{RGB}{235,235,235}
...
\ifx\ConfigTheme\ConfigThemeDark
    ...
    \colorlet{RecordsColor}{ObsBlue!65!fg}
    \colorlet{Recordsbgcolor}{RecordsColor!22!bg}
...
\newcommand{\Yahwist}{\color{Jcolor}} % Or: Creator. We who cause it to be.
\newcommand{\Records}{\color{RecordsColor}\itshape}
\newcommand{\OtherSource}{\color{OtherColor}\itshape}
\newcommand{\DeuteronomistA}{\Mushite\color{Dtr1color}}
\newcommand{\DeuteronomistB}{\Mushite\color{Dtr2color}}
\newcommand{\DeuteronomicLaw}{\Mushite\color{Dtncolor}}
\makeatletter
...
\DeclareSourceProfile{E}
    {\EnglishFont} {\SourceBackground{Ebgcolor}\Levite\Mushite}
    {\PaleoASCIIGezer} {\SourceBackground{Ebgcolor}\Levite\Mushite}
...
\DeclareSourceProfile{P}
    {\EnglishFont}   {\SourceBackground{Pbgcolor}\Levite\Aaronid}
    {\HebrewEzraRaw} {\HebrewEzraLarge\SourceBackground{Pbgcolor}\Levite\Aaronid}
...
\DeclareSourceProfile{Records}
    ...
    {\PaleoASCIISiloam} 	{\SourceBackground{Recordsbgcolor}\Records}
...
\newcommand{\FontChoicePage}{%
    ...
    \noindent\begin{tabular}{@{}p{0.43\linewidth}p{0.51\linewidth}@{}}
        \hJ{אבגדהוזחטיכלמנסעפצקרשת} & \eJ{J is in Paleo-Hebrew because J dates to around 922 B.C.}\\
        \hE{אבגדהוזחטיכלמנסעפצקרשת} & \eE{E is in Paleo-Hebrew from soon after J.}\\
        \hP{אבגדהוזחטיכלמנסעפצקרשת} & \eP{P is the exception: he would have updated the spelling and script to the new writing system, because he was not making any good letter-shape puns anyway. He would have loved niqqud if he had known about them. Aaronids are all about the exact right way to do stuff. P loves the dots. P basically is the dots.}\\
        \hR{אבגדהוזחטיכלמנסעפצקרשת} & \eR{R is in square script because he is probably Ezra, after the Babylonian exile.}\\
    \end{tabular}
    \endgroup
    \cleardoublepage
}
...
\newcommand{\SourceLegendPage}{%
    ...
    \noindent\begin{tabular}{@{}p{0.23\linewidth}p{0.71\linewidth}@{}}
        ...
        {\Mushite Yellow} & {\Levite\Mushite Mushites. A group of Levite priests who claim descent from Moses. Associated with the first temple in the city of Shiloh.} (\MushiteSourceRefs.)\\
        {\Aaronid Blue} & {\Levite\Aaronid Aaronids. A group of Levite priests who claim descent from Aaron. Associated with the first and second temple in the city of Jerusalem.} (\eP{P}, \eR{R}.)\\
        {\DeuteronomistB Orange} & {\Levite\DeuteronomistB Deuteronomists. Mushites after the yellow has been left in the theological toaster.} (\DtrALabel, \DtrBLabel, \DtnLabel.)\\
        {\color{Graycolor}Grey} & {\color{Graycolor}Bureaucracy: records, begat lists, external documents. (Genesis 5, Genesis 14.)}\\[0.7em]
        {\itshape Italics} & {\itshape Songs, Early poetry \LeviteBlend{} (Exodus 15), \cG{Israelites in the North} (Judges 5, Genesis 49), {\Mushite Deuteronomy 32}.}\\
