...
\ifx\ConfigTheme\ConfigThemeDark
    ...
    \definecolor{fg}{HTML}{cfc0a5}
    \colorlet{TextColor}{fg}
    \colorlet{RuleColor}{fg!45!bg}

    \definecolor{ObsGreen}{HTML}{a7c080}
    ...
    \colorlet{Jcolor}{ObsGreen!62!fg}
    \colorlet{Ecolor}{ObsYellow!65!fg}
    \colorlet{Pcolor}{ObsBlue!65!fg}

    \colorlet{Dtr1color}{ObsRed!58!fg}
    \colorlet{Dtr2color}{ObsRed!58!fg}
    \colorlet{Dtncolor}{ObsOrange!60!fg}
    ...
    \colorlet{OtherColor}{ObsGray!70!fg}
...
\DeclareSourceProfile{P}
    ...
    {\HebrewEzraBoldRaw} {\HebrewEzraLarge\color{Pcolor}}
...
\newcommand{\SourceLegendPage}{%
    ...
    \noindent\begin{tabular}{@{}p{0.23\linewidth}p{0.71\linewidth}@{}}
        Regular & Authors. Usually early. Some later. (J, Records, Songs.)\\
        Bold & \textbf{Priests. Usually later. Some early. (E, P, Dtr1, Dtr2, Dtn.)}\\
        Background & \LegendSample{\colorbox{Rbgcolor}{\strut Redactors.}} Primarily Editors, rarely or less frequently Authors.\\
        No Background & Redactors. Primarily Editors, rarely or less frequently Authors.\\[0.7em]
        Green & \eJ{J. The first author. The oldest source in the bible, with the exception of archaic songs. (J)}\\
        Yellow & \eE{Mushites. A group of Levite priests who claim descent from Moses. Associated with the first temple in the city of Shiloh. (E, Dtr1, Dtr2, Jeremiah)}\\
        Blue & \eP{Aaronids. A group of Levite priests who claim descent from Aaron. Associated with the first and second temple in the city of Jerusalem. (P, R)}\\
        Red & {\color{Redcolor}Songs. Early poetry of Levites in the south, Israelites in the north, or other sources. (Genesis 49, Exodus 15, Deuteronomy 32)}\\
        Grey & {\color{Graycolor}Other. Records, Begat lists, genealogies, external documents. (Genesis 5, Genesis 14.)}\\[0.7em]
        Dark & \cK{Laws.}\\
        Dark Blue & \cB{Aaronid Laws. (Leviticus, Exodus 25-40.)}\\
        Dark Yellow & \cR{Mushite Laws. (Covenant code in Exodus, Deuteronomistic Law code.)}\\
        Dark Green & \cK{J Laws. (Rare, outside of a version of the 10 commandments, which may have been a joke.\footnote{J is the funny one.})}\\
    \end{tabular}
    \endgroup
    \cleardoublepage
}
