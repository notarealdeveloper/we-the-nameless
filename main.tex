...
\newcommand{\SourceLegendPage}{%
    ...
    \noindent\begin{tabular}{@{}p{0.23\linewidth}p{0.71\linewidth}@{}}
        Regular & Authors. Usually early. Some later. (\SourceRefs.)\\
        \textbf{Bold} & \textbf{Priests. Usually later. Some early. (\PriestSourceRefs.)}\\
        \eR{Background} & \eR{Redactors.} Primarily Editors, rarely or less frequently Authors.\\
