...
\definecolor{Ecolor}{RGB}{170,120,0}
\definecolor{Pcolor}{RGB}{0,70,170}
\definecolor{Dtr1color}{RGB}{170,120,0}
\definecolor{Dtr2color}{RGB}{195,135,0}
\definecolor{Dtncolor}{RGB}{150,95,0}
...
\colorlet{OtherColor}{ProtoColor}
...
\definecolor{Yellowcolor}{RGB}{170,120,0}
...
\ifx\ConfigTheme\ConfigThemeDark
    ...
    \colorlet{Dtr1color}{Ecolor}
    \colorlet{Dtr2color}{ObsOrange!72!ObsYellow}
    \colorlet{Dtncolor}{ObsOrange!78!fg}

    \colorlet{Rcolor}{ObsBlue!65!fg}
    \definecolor{Rbgcolor}{HTML}{34404f}
    \colorlet{RJEcolor}{Jcolor}
    \colorlet{RJEbgcolor}{Ecolor}

    \colorlet{RecordsColor}{ObsBlue!65!fg}
    \definecolor{Recordsbgcolor}{HTML}{575d5f}
    \colorlet{OtherColor}{ObsGray!90!fg}

    \colorlet{Kcolor}{fg}
    \colorlet{Redcolor}{ObsRed!58!fg}
    \colorlet{Bluecolor}{ObsBlue!65!fg}
    \colorlet{Greencolor}{ObsGreen!62!fg}
    \colorlet{Yellowcolor}{Dtncolor}
...
\newcommand{\eBookOfRecords}[1]{{\estyleRecords\highLight[Recordsbgcolor]{#1}}}
\newcommand{\hBookOfRecords}[1]{\highLight[Recordsbgcolor]{\hRecordsRenderer{\hstyleRecords}{#1}}}
\newcommand{\sBookOfRecords}[1]{{\estyleRecords\highLight[Recordsbgcolor]{#1}}}
...
\newcommand{\RJESourceName}{\ensuremath{R^{\mathrm{E}}_{\mathrm{J}}}}
...
\newcommand{\SourceRefs}{%
    ...
    {\color{Redcolor}Songs}%
}

\newcommand{\PriestSourceRefs}{%
    \eE{E}, %
    \eP{P}, %
    {\bfseries\color{Dtr1color}Dtr1}, %
    {\bfseries\color{Dtr2color}Dtr2}, %
    {\bfseries\color{Dtncolor}Dtn}%
}
...
\newcommand{\SourceLegendPage}{%
    ...
    \noindent\begin{tabular}{@{}p{0.23\linewidth}p{0.71\linewidth}@{}}
        Regular
        & Authors. Usually early. Some later. (\SourceRefs.)\\
        ...
        \eR{Background}
        & \eR{Redactors.} Primarily Editors, occasionally write a bit of glue prose.\\
        \estyleR{No Background} & \estyleR{Redactors. Primarily Editors, rarely or less frequently Authors.}\\[0.7em]
        \eJ{Green} & \eJ{J. The first author of the bible.\footnotemark{}
            The first author of prose on earth.\footnotemark{}
            The author of nearly all the most popular bible stories.\footnotemark{}
            The author in the bible with the best sense of humor.\footnotemark{}}\\
        \eE{Yellow} & \eE{Mushites. A group of Levite priests who claim descent from Moses. Associated with the first temple in the city of Shiloh. (E, Dtr1, Dtr2, Jeremiah)}\\
        ...
        {\color{Redcolor}Red} & {\color{Redcolor}Songs. Early poetry of Levites in the south, Israelites in the north, or other sources. (Genesis 49, Exodus 15, Deuteronomy 32)}\\
        {\color{Graycolor}Grey} & {\color{Graycolor}Other. Records, Begat lists, genealogies, external documents. (Genesis 5, Genesis 14.)}\\[0.7em]
        \cK{Dark} & \cK{Laws.}\\
        \cB{Dark Blue} & \cB{Aaronid Laws. (Leviticus, Exodus 25-40.)}\\
        \cY{Dark Yellow} & \cY{Mushite Laws. (Covenant code in Exodus, Deuteronomistic Law code.)}\\
        \cG{Dark Green} & \cG{J Laws. (Rare, outside of a version of the 10 commandments, which may have been a joke.\footnote{J is the funny one.})}\\
    \end{tabular}
    \footnotetext{Aside from a few brief archaic songs.}
    \footnotetext{As far as we know.}
    \footnotetext{Not including the Jesus bits, though J's at least tied.}
    \footnotetext{And the most misunderstood.}
    \endgroup
    \cleardoublepage
}
