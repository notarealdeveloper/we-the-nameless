...
% ------------------------------------------------------------
\iffalse
\section{nav: hanging paragraphs/footnotes}
\fi
...
% ------------------------------------------------------------
\iffalse
\section{nav: plain color commands}
\fi
...
% ------------------------------------------------------------
\iffalse
\section{nav: hebrew encoders/font profiles}
\fi
...
\DeclareSourceProfile{P}
    ...
    {\PaleoASCIIIsaiahScroll} {\SourceBackground{Pbgcolor}\Aaronid}
...
% ------------------------------------------------------------
\iffalse
\section{nav: explicit hebrew font helpers}
\fi
...
% ------------------------------------------------------------
\iffalse
\section{nav: inline language helpers}
\fi
...
% ------------------------------------------------------------
\iffalse
\section{nav: legend/pages}
\fi

\newcommand{\RSourceName}{R}
\newcommand{\RJESourceName}{R}
...
\include{5-dudetheyreontome/A-apocrypha/1-genesis}
