...
\newcommand{\HebrewEzraLarge}{\addfontfeatures{Scale=1.23}}
...
\DeclareSourceProfile{Records}
    ...
    {\PaleoASCIITelZayit} {\color{RecordsColor}\itshape}
...
\DeclareSourceProfile{Proto}
    {\EnglishFont} {\color{Jcolor}\mdseries}
    {\ProtoASCIIFifteenthCentury} {\color{Jcolor}\mdseries}
...
\DeclareSourceCommandList{J,E,P,DtrOne,DtrTwo,DtrA,DtrB,Dtn,Records,Other,Proto}
...
\DeclareSpeakerShortcut{DtrOne}{\eDtrOne}
\DeclareSpeakerShortcut{DtrTwo}{\eDtrTwo}
...
\DeclareSpeakerTripletList{A,B,C,J,E,P,DtrOne,DtrTwo,Dtn,R,RJE,Records,Other}
