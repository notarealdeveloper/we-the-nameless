...
\ifx\ConfigTheme\ConfigThemeDark
    % Everforest dark, slightly Obsidian-muted
    \definecolor{bg}{HTML}{2d353b}
    \definecolor{fg}{HTML}{d3c6aa}
    \definecolor{RuleColor}{HTML}{859289}

    \definecolor{ProtoColor}{HTML}{9da9a0}
    \definecolor{PaleoColor}{HTML}{a7bd82}
    ...
    \definecolor{Jcolor}{HTML}{a7bd82}      % muted green
    \definecolor{Ecolor}{HTML}{d6b979}      % softer yellow
    \definecolor{Pcolor}{HTML}{83b7b0}      % less cyan than 7fbbb3

    \definecolor{Dtr1color}{HTML}{df7c7e}
    \definecolor{Dtr2color}{HTML}{df7c7e}
    \definecolor{Dtncolor}{HTML}{df9270}

    \definecolor{Rcolor}{HTML}{df7c7e}
    \definecolor{Rbgcolor}{HTML}{4a3a40}    % darker, less glowing
    \definecolor{RJEcolor}{HTML}{a7bd82}
    \definecolor{RJEbgcolor}{HTML}{3d4942}

    \definecolor{RecordsColor}{HTML}{83b7b0}
    \definecolor{OtherColor}{HTML}{a7bd82}

    \definecolor{Kcolor}{HTML}{d3c6aa}
    \definecolor{Redcolor}{HTML}{df7c7e}
    \definecolor{Bluecolor}{HTML}{83b7b0}
    \definecolor{Greencolor}{HTML}{a7bd82}
    \definecolor{Graycolor}{HTML}{9da9a0}
    \definecolor{DefColor}{HTML}{d6b979}
