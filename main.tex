...
\newcommand{\LawRows}{%
    ...
    \LawRow{\cG{J Laws}}{\cG{Rare. Possibly a joke.\textsuperscript{5}}}%
}
...
\newcommand{\SourceLegendPage}{%
    ...
    \noindent\begin{tabular}{@{}p{0.23\linewidth}p{0.71\linewidth}@{}}
        ...
        {\DeuterB{\Redactor Orange}} & {\DeuterB Deuteronomists. Mushites after the Yellohist has been left in the theological toaster.} (\DtrALabel, \DtrBLabel, \DtnLabel.)\\
        {\Record Grey} & {\Record Bureaucracy: records, accounting, begat lists, external documents. (Genesis 5, Genesis 14.)}\\[0.7em]
        {\Poetry Italics} & {\Poetry Songs, early poetry,
        	of the \Levite{Levites} in the South \Mushite{(}\Aaronid{Exodus 15}\Mushite{)},\\
        	of the \cG{Israelites} in the North \cG{(Judges 5, Genesis 49)},\\
        	and possibly older texts later included by the Deuteronomistic Historians {\Mushite (Deuteronomy 32).}}\\
        {\LawFont Mono} & {\LawFont All forms of code, including legal codes, for reasons that need not be explained.}\\
        \LawRows
    \end{tabular}
    \par\smallskip
    {\scriptsize
    \textsuperscript{1}Not according to \Aaronid{these guys}, though \Mushite{these guys} agree.\par
    \textsuperscript{2}Aside from a few archaic songs.\par
    \textsuperscript{3}Here on Earth, that is, as far as we know.\par
    \textsuperscript{4}And the most misunderstood.\par
    \textsuperscript{5}She's the funny one.\par
    }
    \endgroup
    \cleardoublepage
    \FontChoicePage
