...
\newcommand{\LawRow}[2]{%
    \texttt{#1} & {\raggedright\arraybackslash\texttt{#2}}\\%
}
...
\newcommand{\LeviteBlend}{%
    \cY{Of the Levites} \cB{in the South}%
}
...
\newcommand{\SourceLegendPage}{%
    ...
    \noindent\begin{tabular}{@{}p{0.23\linewidth}p{0.71\linewidth}@{}}
        ...
        \eR{Background}
        & \eR{Redactors. Primarily editors, occasionally writers of glue prose.}\\[0.7em]
        ...
        {\itshape Songs} & {\itshape Early poetry: \LeviteBlend{} (Exodus 15), \cG{Israelites in the North} (Judges 5, Genesis 49), or \cY{Deuteronomy 32}.}\\
        {\itshape\color{Yellowcolor}Prophecy} & {\itshape\color{Yellowcolor}Jeremiah and other prophetic material.}\\
        {\itshape\color{Graycolor}Grey} & {\itshape\color{Graycolor}Bureaucracy: records, begat lists, genealogies, external documents. (Genesis 5, Genesis 14.)}\\[0.7em]
        \texttt{Mono} & \texttt{All forms of code, including legal codes.}\\
        \LawRows
    \end{tabular}
    \endgroup
    \cleardoublepage
