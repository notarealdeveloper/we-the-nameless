...
\definecolor{Dtr1color}{RGB}{170,130,0}
\definecolor{Dtr2color}{RGB}{185,115,0}
\definecolor{Dtncolor}{RGB}{185,145,0}
...
\ifx\ConfigTheme\ConfigThemeDark
    ...
    \colorlet{Dtr1color}{ObsYellow!74!fg}
    \colorlet{Dtr2color}{ObsYellow!55!ObsOrange}
...
\DeclareSourceProfile{E}
    {\EnglishFont} {\color{Ecolor}\Eweight}
    {\HebrewDavid} {\HebrewDavidLarge\color{Ecolor}\Eweight}
...
\DeclareSourceProfile{Dtn}
    {\LawFont} {\color{Dtncolor}\mdseries}
    {\HebrewDavid} {\HebrewDavidLarge\color{Dtncolor}\mdseries}

% Aaronids

\DeclareSourceProfile{P}
    {\EnglishFont}   {\color{Pcolor}\Pweight}
...
\newcommand{\DtrALabel}{\highLight[Dtr1bgcolor]{\color{Dtr1color}D}}
\newcommand{\DtrBLabel}{\highLight[Dtr2bgcolor]{\color{Dtr2color}D}}
\newcommand{\DtnLabel}{{\LawFont\color{Dtncolor}Dtn}}
...
\newcommand{\LawRows}{%
    \LawRow{\cB{Aaronid Laws}}{\cB{Leviticus; Exodus 25--40.}}%
    \LawRow{\cY{Mushite Laws}}{\cY{Covenant Code in Exodus; Deuteronomistic Law Code.}}%
    \LawRow{\cG{J Laws}}{\cG{Rare. Possibly a joke.\footnote{J is the funny one.}}}%
}

\newcommand{\LeviteBlend}{%
    \cY{Of the Levites} \cY{in the South}%
}
...
\newcommand{\SourceLegendPage}{%
    ...
    \noindent\begin{tabular}{@{}p{0.23\linewidth}p{0.71\linewidth}@{}}
        ...
        \textbf{Bold} & \textbf{The Priests. Or the Levites. Same thing.}%
        ...
        \eE{Yellow} & \eE{Mushites. A group of Levite priests who claim descent from Moses. Associated with the first temple in the city of Shiloh.} (\MushiteSourceRefs.)\\
        \eP{Blue} & \eP{Aaronids. A group of Levite priests who claim descent from Aaron. Associated with the first and second temple in the city of Jerusalem. (P, R)}\\
        \textit{Italics} & \textit{Songs, poetry, and prophecy.}\\
        {\itshape Songs} & {\itshape Early poetry: \LeviteBlend{} (Exodus 15), \cG{Israelites in the North} (Judges 5, Genesis 49), \cY{Deuteronomy 32}, Jeremiah, and other prophetic material.}\\
        {\color{Graycolor}Grey} & {\color{Graycolor}Bureaucracy: records, begat lists, genealogies, external documents. (Genesis 5, Genesis 14.)}\\[0.7em]
        {\LawFont Mono} & {\LawFont All forms of code, including legal codes.}\\
        \LawRows
    \end{tabular}
    \endgroup
    \cleardoublepage
