...
\newfontfamily\PhoenicianFont[
    Path=\LocalFontPath,
    BoldFont=noto-sans-phoenician-regular.ttf,
    Scale=1.22
...
\newcommand{\hangingfootnote}[2]{%
    \parbox[t]{\linewidth}{%
        \parindent=0pt
        \everypar{\hangindent=#1\hangafter=1}%
        #2%
    }%
}
...
\definecolor{PaleoColor}{RGB}{100,100,100}
...
\directlua{
  ...
  local ascii_variants = {
    proto_a = nil,
    proto_b = variant_map {"a","b","g","s","h","w","Z","x","j","y","k","l","m","n",bs..";","]","p",bs..";c"..bs..",","q"..bs..",","r"..bs..",","f"..bs..",","t"},
    proto_c = variant_map {"A","B","G","S","H","W","Z","X","j","Y",bs..";K","L","M"..bs..",","N"..bs..";","]","P"..bs..";","C"..bs..",","Q"..bs..",","R"..bs..",","V"..bs..",","T"},
    proto_d = variant_map {"A","B","G","D",bs.."!h","w"..bs.."!","Z","X","J","Y","K","L","M","N","S","]"..bs..";","P"..bs..";","C"..bs..";","Q"..bs..";","R"..bs..";","V"..bs..";","T"},
    proto_e = variant_map {"a","b"..bs.."!","g","d","H","W"..bs.."!","z","x","j","y","k","l","M","n","s","]"..bs..";","p","c","q"..bs..";","r"..bs..",","v"..bs..",","t"},
    proto_f = variant_map {"A","B","G","D","H"..bs..";","W","Z","X","J"..bs.."!","Y"..bs.."!","K","L"..bs..";","","N","S","]","P","C"..bs..";","Q"..bs..";","R"..bs..",","V",bs..",T"},
    proto_g = variant_map {"a","b","g","d","h"..bs..";","w","z","x","j"..bs.."!","y","k","l","","n","s","]","p"..bs.."!","c"..bs..",","q","R",bs..",v",bs..",t"},
    ...
    paleo_a = variant_map {"a","b","g","d","h","w",bs.."!z","x","j","y","k","l","m","n","s","]","p"..bs.."!","c","q"..bs..",","r"..bs..",","v"..bs..",","t"},
    paleo_b = variant_map {"A",bs..";B","G"..bs..",","D","H"..bs..";","W","Z","X"," ","Y","K","L","M"," ","S","]","P","C","Q","R","V","T"},
    paleo_c = variant_map {"a",bs..",b","g",bs.."!d","h"..bs.."!","w","z","x"," ","y","k","l","m"..bs..";"," ","s","]","p"..bs.."!","c","q","r","v","t"},
    paleo_h = variant_map {"A","B","G","D","H","W","Z","X","J","Y","K","L","M","N","S","]","P","C","Q","R","V","T"},
    paleo_i = variant_map {"a","b","g","d","h","w","z"..bs..",","x","j","y"..bs..";","k","l","m","n","s","]","p","c",bs..",q"..bs..",","r","v","t"},
    paleo_k = variant_map {"A","B","G","D","H","W","Z","X","J","Y"..bs..",","K"..bs..",","L"..bs..",","M"..bs..",","N","S","]","P","C","Q","R","V","T"},
    paleo_l = variant_map {"a","b","g","d","h","w","z","x","j","y","k","l","m","n","s","]","p","c"..bs..",","q"..bs..",","r"..bs..",","v","t"},
    paleo_w = variant_map {"A","B","G","D","H","W","Z","X","J","Y","K"..bs..",","L"..bs..",","M"..bs..",","N","S","]","P","C","Q","R","V","T"},
    paleo_x = variant_map {"a","b","g","d","h","w","z","x","j","y","k","l","m","n","s","]","p","c","q","r","v","t"}
  }

  local function hebrew_to_ascii_variant(s, variant)
  ...
  function paleotex.hebrew_to_phoenician(s)
    local out = {}
    for pos, code in utf8.codes(s) do
      local mapped = phoenician[code]
      if mapped ~= nil then
        table.insert(out, utf8.char(mapped))
      else
        mapped = hebrew_punctuation[code]
  ...
  function paleotex.hebrew_to_ascii_variant(s, variant)
    return hebrew_to_ascii_variant(s, variant)
  end
  ...
  function hebrew_to_phoenician(s)
    return paleotex.hebrew_to_phoenician(s)
  end
...
\newcommand{\EncodePhoenician}[1]{\HebrewToPhoenician{#1}}
\newcommand{\EncodeAramaic}[1]{\HebrewToAramaic{#1}}
\newcommand{\EncodeASCIIVariant}[2]{%
  \directlua{tex.sprint(hebrew_to_ascii_variant("\luaescapestring{\detokenize{#2}}", "\luaescapestring{#1}"))}%
}
...
\DeclareHebrewRenderer{Phoenician}{\PhoenicianFont}{\EncodePhoenician}
...
\DeclareHebrewRenderer{ProtoAFont}{\ProtoSinaiticBestFont}{\EncodeHebrewNoNiqqud}
...
\DeclareHebrewRenderer{PaleoHFont}{\PaleoHebrewFont}{\EncodePaleoH}
\DeclareHebrewRenderer{PaleoIFont}{\PaleoHebrewFont}{\EncodePaleoI}
\DeclareHebrewRenderer{PaleoJFont}{\PaleoHebrewRoboFont}{\EncodePaleoUnicode}
...
\DeclareSourceProfile{J}
    ...
    {\Phoenician}  {\color{Jcolor}\mdseries}
...
\newcommand{\Paleo}[1]{\Phoenician{}{#1}}
...
\newcommand{\phn}[1]{%
    {\leavevmode\textdir TRT\PhoenicianFont #1}%
}
