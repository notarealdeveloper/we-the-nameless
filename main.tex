...
\DeclareHebrewRenderer{PaleoJFont}{\Phoenician}{\EncodePhoenician}
...
\DeclareSourceProfile{J}
    ...
    {\PaleoJFont}  {\color{Jcolor}\mdseries}
...
\newcommand{\hProtoVariant}{\hProtoA}
\newcommand{\hPaleoVariant}{\hPaleoA}
\renewcommand{\hProto}[1]{\hProtoVariant{#1}}
\renewcommand{\hPaleo}[1]{\hPaleoVariant{#1}}
