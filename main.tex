...
\newcommand{\MushiteSourceRefs}{%
    ...
    {\bfseries\color{Dtr2color}Dtr2}, %
    {\bfseries\color{Dtncolor}Dtn}, %
    {\color{Dtncolor}Jeremiah}%
}

\newcommand{\LawSample}{%
    \texttt{\cK{Laws.} %
    \cB{Aaronid Laws. (Leviticus, Exodus 25-40.)} %
    \cY{Mushite Laws. (Covenant code in Exodus, Deuteronomistic Law code.)} %
    \cG{J Laws. (Rare, outside of a version of the 10 commandments, which may have been a joke.\footnote{J is the funny one.})}}%
}
...
\newcommand{\SourceLegendPage}{%
    ...
    \noindent\begin{tabular}{@{}p{0.23\linewidth}p{0.71\linewidth}@{}}
        ...
        \multicolumn{2}{@{}p{0.94\linewidth}@{}}{\textit{Italics are for things we don't usually put in books. Red is the passionate creative stuff like songs. Grey is the bureaucracy like begat lists.}}\\
        {\itshape\color{Redcolor}Red} & {\itshape\color{Redcolor}Songs. Early poetry of Levites in the south, Israelites in the north, or other sources. (Genesis 49, Exodus 15, Deuteronomy 32)}\\
        {\itshape\color{Graycolor}Grey} & {\itshape\color{Graycolor}Other. Records, Begat lists, genealogies, external documents. (Genesis 5, Genesis 14.)}\\[0.7em]
        \texttt{Monospaced} & Any code of any form, including legal codes, are displayed in monospaced font, for reasons that need not be explained. The color indicates the author or group of authors. \LawSample\\
    \end{tabular}
