...
\newcommand{\SourceLegendPage}{%
    ...
    \noindent\begin{tabular}{@{}p{0.23\linewidth}p{0.71\linewidth}@{}}
        ...
        {\Mushite{Yellow}}
        & {\Mushite Mushites. A group of Levite priests who claim descent from Moses. Associated with the first temple in the city of Shiloh.}
          (\eE{E}, \DtrALabel, \DtrBLabel, \DtnLabel, {\itshape\color{Yellowcolor}Jeremiah}.)\\
        ...
        {\LawFont{\Aaronid Aaronid Laws}} & {\LawFont{\Aaronid Leviticus; Exodus 25-40.}}\\
        {\LawFont{\Mushite Mushite Laws}} & {\LawFont{\Mushite Covenant Code in Exodus; Deuteronomistic Law Code.}}\\
        {\LawFont\cG{J Laws}} & {\LawFont\cG{Rare. Possibly a joke.\textsuperscript{5}}}\\
    \end{tabular}
    \par\smallskip
    {\scriptsize
