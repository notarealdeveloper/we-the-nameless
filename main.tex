...
\DeclareSourceCommandList{J,E,P,DtrA,DtrB,Dtn,Records,Other}
\newcommand{\eProto}[1]{{\estyleProto #1}}
\newcommand{\hProto}[1]{\hProtoRenderer{\hstyleProto}{#1}}
\newcommand{\sProto}[1]{{\estyleProto #1}}
