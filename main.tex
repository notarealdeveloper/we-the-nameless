...
\colorlet{Dtr1color}{Ecolor!92!black}
\colorlet{Dtr2color}{Ecolor!65!orange}
...
\ifx\ConfigTheme\ConfigThemeDark
    ...
    \colorlet{Dtr1color}{Ecolor!84!fg}
    \colorlet{Dtr2color}{Ecolor!60!ObsOrange}
    \colorlet{Dtncolor}{Ecolor}
...
\DeclareSourceProfile{E}
    ...
    {\HebrewDavid} {\HebrewDavidLarge\SourceBackground{Ebgcolor}\Levite\Mushite}

\DeclareSourceProfile{DtrA}
    {\EnglishFont} {\SourceBackground{Dtr1bgcolor}\Levite\DeuteronomistA}
    {\HebrewDavid} {\HebrewDavidLarge\SourceBackground{Dtr1bgcolor}\Levite\DeuteronomistA}

\DeclareSourceProfile{DtrB}
    {\EnglishFont} {\SourceBackground{Dtr2bgcolor}\Levite\DeuteronomistB}
    {\HebrewDavid} {\HebrewDavidLarge\SourceBackground{Dtr2bgcolor}\Levite\DeuteronomistB}

\DeclareSourceProfile{Dtn}
    {\LawFont} {\SourceBackground{Dtnbgcolor}\Levite\DeuteronomicLaw}
    {\HebrewDavid} {\HebrewDavidLarge\SourceBackground{Dtnbgcolor}\Levite\DeuteronomicLaw}
...
\DeclareSourceProfile{R}
    {\EnglishFont}   {\SourceBackground{Rbgcolor}\Levite\Aaronid\Redactor}
    {\HebrewEzraRaw} {\SourceBackground{Rbgcolor}\Levite\Aaronid\Redactor}
...
\newcommand{\DtrALabel}{\eDtrA{D}}
\newcommand{\DtrBLabel}{\eDtrB{D}}
...
\newcommand{\LawRows}{%
    ...
    \LawRow{\cG{J Laws}}{\cG{Rare. Possibly a joke.\footnote{J is the funny one.}}}%
}
...
\newcommand{\FontChoicePage}{%
    ...
    \noindent\begin{tabular}{@{}p{0.43\linewidth}p{0.51\linewidth}@{}}
        \hJ{אבגדהוזחטיכלמנסעפצקרשת} & \eJ{J: explain this}\\
        \hE{אבגדהוזחטיכלמנסעפצקרשת} & \eE{E: explain this}\\
        \hP{אבגדהוזחטיכלמנסעפצקרשת} & \eP{P: explain this}\\
        \hR{אבגדהוזחטיכלמנסעפצקרשת} & \eR{R: explain this}\\
    \end{tabular}
    \endgroup
    \cleardoublepage
}
...
\newcommand{\SourceLegendPage}{%
    ...
    \noindent\begin{tabular}{@{}p{0.23\linewidth}p{0.71\linewidth}@{}}
        ...
        \footnote{According to the Mushites, but not the Aaronids. That'll make sense eventually.}%
        (\PriestSourceRefs.)\\

        {\SourceBackground{Rbgcolor}\Redactor Background}
        & {\SourceBackground{Rbgcolor}\Redactor Redactors. Editors, occasionally write small amounts of glue prose to make multiple sources consistent,} {\SourceBackground{RJEbgcolor}\Redactor while others write less and delete more from their sources.}\\[0.7em]
        \eJ{Green} & \eJ{J. The first author of the bible.\footnote{Aside from a few brief archaic songs.}
            The first author of prose on earth.\footnote{As far as we know.}
            The author of nearly all the most popular bible stories.\footnote{Not including the Jesus bits, though J's at least tied.}
            The author in the bible with the best sense of humor.\footnote{And the most misunderstood.}}\\
