...
\newcommand{\Mushite}{\color{Ecolor}}
\newcommand{\Aaronid}{\color{Pcolor}}
...
\DeclareSourceProfile{P}
    {\EnglishFont}  {\SourceBackground{Pbgcolor}\Aaronid\Levite}
	{\HebrewEzra} 	{\SourceBackground{Pbgcolor}\Aaronid}
...
\ifx\ConfigTheme\ConfigThemeDark
	...
	%\definecolor{Redactedcolor}{HTML}{54609f}
	%\definecolor{Redactedcolor}{RGB}{0,70,170}
	\colorlet{Redactedcolor}{Bluecolor}
...
% ------------------------------------------------------------
% Deprecated, someone please remove me from main.tex and the book
% ------------------------------------------------------------

\iffalse
\section{nav: the damned}
\fi
...
% TODO: If you're reading this, can we make the
% \Book command automatically create the nav here
% without making there be fictitious nav stuff
% at the location where the \Book command is
% defined due to texmaker seeing the embedded
% \chapter or whatever inside it?
...
% TODO: Can we make this cruft happen inside the \Book command?
% I think it would be nice to have 2 kinds of page numbers,
% one globally and the other resetting to 1 in each book.
\cleardoublepage
