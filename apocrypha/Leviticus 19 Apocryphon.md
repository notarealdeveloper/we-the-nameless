    ...
    Our philosophies ask countless questions that sound deceptively similar to this one
    without ever approaching the thought processes required to address the question quite right.

    To see the truth(,s) of the matter(,s) we need a broader vantage than our co(mmon + nventions)
    of propriety & the parochial boundaries of (,our) culture(,s) permit because as we al(l,ready)
    know from all the old cliches it never has been age per se that makes us rot.
...
& large) are decoupled from time th{,r}ough time's linearity an unavoidable correlation between age & these experiences arises & the result is that over a lifetime we may age like wine or like meat || like cheese or like bread && the manners of rot | lack thereof take 二 many forms 二 enumerate here 一 but as we all know 一 though a thing may be all around us our brains for some reason stubbornly refuse to feel certain timeless truths until they present themselves to us as a parable by example (though,) fortunately (,though) it turns out to be pretty simple to find ourselves plenty of examples. All we have to do is to open our eyes and look, at what is (& always has been) all around us. So by way of example:
    ...
    2. A popular phrase in the standard modern dialect of distributed colloquial vernacular,
       ...
       a large quantity of something, or any number higher than seven/qi/七, for example: 9001.
                                       │                                                    │
                                       │                                                    │
    1. A quantity of time (equal to 9001 of a certain time(時) interval(間) (or more simply 時間 (no wait
...
-K, Circa nearabouts 1 month & 1 day after the first day of K's first over-9000th day.
...
So once A started writing and publishing stuff (and then once a bit of time passed and people started to see it) it (a.k.a. A's stuff) pretty quickly turned out to be so damn exciting/inspiring/[something-like-that] that lots of different student people in all sorts of countries said "Okay fuck school." (or something like that) "This place is the worst. But this book-thing is great. Enough is enough. Life is short. I'm gonna go hang out with A," and then they left their old schools in the countries they were sitting in & instead of sitting there they went somewhere else, to a different kind of country, so they could go explore a new place and try life again, and maybe while they were there they could also learn stuff from A.
    ...
    ) kept writing and they wrote about lots of different stuff,
    and if we stick kinda roughly sort-of(-ish) to their (time,)
    li(n,v)es the writings they wrote sounded something like this.
