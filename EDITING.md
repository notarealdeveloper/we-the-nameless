...
Gen 1,2,3: Remove manual line breaks in the english (\\eP{}, \\eJ{}, \\eR{}) and hebrew (\\hP{}, \\hJ{}, \\hR{}) blocks (not the commentary blocks) that sometimes occur early on, primarily in the early chapters of `[01][0-9]-*/*.tex` like `01-genesis/0[123].tex` and maybe `01-genesis/0[456].tex`
