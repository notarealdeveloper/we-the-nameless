...
}
{
	\eP{
		...
		vow to make a separation for YHWH,
	}
}
{
%	\footnote{
...
}
{
	\eP{
		...
		die, because the crown of his God is on his head.
	}
}
{
%	\footnote{
%		the crown of his God is on his head. As I noted in the case of the high
%		priest, the Hebrew term nzer has the same range as the English
...
}
{
	\eP{
		...
		fall because his Nazirite state became impure.
	}
}
{
%	\footnote{
...
}
{
	\eP{
		...
		and one unblemished ram for a peace offering
	}
}
{
}
...
}
{
	\eP{
		...
		shall do his sin offering and his burnt offering.
	}
}
{
}
...
}
{
	\eP{
		...
		shall do his grain offering and his libation.
	}
}
{
}
...
}
{
	\eP{
		...
		shall bless the children of Israel; say to them:
	}
}
{
%	\footnote{
...
\Verse{24}
{
	\hPaleoM{יְבָרֶכְךָ יְהֹוָה וְיִשְׁמְרֶךָ׃}
}
{
	\eP{May YHWH bless you and watch over you. }
}
{
%	\footnote{
...
\Verse{25}
{
	\hPaleoM{יָאֵר יְהֹוָה פָּנָיו אֵלֶיךָ וִיחֻנֶּךָּ׃}
}
{
	\eP{
...
\Verse{26}
{
	\hPaleoM{יִשָּׂא יְהֹוָה פָּנָיו אֵלֶיךָ וְיָשֵׂם לְךָ שָׁלוֹם׃}
}
{
	\eP{May YHWH raise His face to you and give you peace. }
}
{
%	\footnote{
