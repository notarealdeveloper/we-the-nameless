...
{
	I'll come back at the appointed time.\aB{When?}
	
	At life time.\aB{Thanks, got it.}
...
{
	Anyways the people\aB{I give up.} get up and go look at Sodom off in the distance.
...
}
{
	...
	He does a ``dollar ninety-nine'' sort of thing.\aB{In reverse.}
