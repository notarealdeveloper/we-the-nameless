...
{
%	Wake up sleepers\footnote{Original Text (OT) has Heb. \heb{נרדם} here.}
%	
%	Prop\footnote{Spelling varies between manuscripts, most notably `\heb{אפ יתר}' in OT.}
%	yourselves\footnote{Lit. `\heb{יהו} selves' in OT.}
